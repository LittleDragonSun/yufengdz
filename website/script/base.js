(function (bd, L) {
            ...
            if (b6) {
              for (; b3 < b1; b3++) {
                b6(
                  b0[b3],
                  b9,
                  b2 ? b7.call(b0[b3], b3, b6(b0[b3], b9)) : b7,
                  b8
                );
              }
            }
  ...
  b.support = (function () {
    ...
    b(function () {
      var bM,
        ...
        e,
        bT,
        bS = av.getElementsByTagName("body")[0];
      if (!bS) {
        return;
      }
      bL = 1;
      ...
      bM.style.cssText =
        e + "width:0;height:0;position:static;top:0;margin-top:" + bL + "px";
      ...
      if (bd.getComputedStyle) {
        ...
        bv.style.width = "2px";
        bv.appendChild(bR);
        bI.reliableMarginRight =
          (parseInt(
            (bd.getComputedStyle(bR, null) || { marginRight: 0 }).marginRight,
            10
          ) || 0) === 0;
      }
      ...
      if (bd.getComputedStyle) {
        ...
        bI.pixelMargin =
          (bd.getComputedStyle(bv, null) || { marginTop: 0 }).marginTop !==
          "1%";
      }
  ...
  b.fn.extend({
    attr: function (e, bv) {
      if (
        $(this).is("#layer89D66E0F70E654D1A364638424313489") &&
        e == "deleted"
      ) {
        console.trace();
      }
    ...
    prop: function (e, bv) {
      if ($(this).is(".wp-new-prodcuts-detail-button-c img")) {
        console.log(e, bv);
      }
    ...
    hasClass: function (e) {
      ...
      for (; bw < bv; bw++) {
        if (
          this[bw].nodeType === 1 &&
          (" " + this[bw].className + " ").replace(aQ, " ").indexOf(bx) > -1
        ) {
          return true;
        }
      }
      ...
      tabIndex: {
        get: function (bv) {
          ...
          return e && e.specified
            ? parseInt(e.value, 10)
            : C.test(bv.nodeName) || (l.test(bv.nodeName) && bv.href)
            ? 0
            : L;
        },
      },
  ...
  if (!E) {
    ...
    bf = b.valHooks.button = {
      get: function (bw, bv) {
        ...
        return e && (aG[bv] ? e.nodeValue !== "" : e.specified)
          ? e.nodeValue
          : L;
      },
    ...
    dispatch: function (bH) {
      ...
      for (bJ = 0; bJ < bv.length && !bH.isPropagationStopped(); bJ++) {
        ...
        for (
          ...
          if (
            bE ||
            (!bH.namespace && !e.namespace) ||
            (bH.namespace_re && bH.namespace_re.test(e.namespace))
          ) {
            bH.data = e.data;
            bH.handleObj = e;
            bK = (
              (b.event.special[e.origType] || {}).handle || e.handler
            ).apply(bB.elem, bx);
            if (bK !== L) {
              bH.result = bK;
              if (bK === false) {
    ...
    off: function (bw, e, by) {
      if (bw && bw.preventDefault && bw.handleObj) {
        ...
        b(bw.delegateTarget).off(
          bv.namespace ? bv.origType + "." + bv.namespace : bv.origType,
          bv.selector,
          bv.handler
        );
        return this;
      ...
      return b.access(
        ...
        function (bv) {
          return bv === L
            ? b.text(this)
            : this.empty().append(
                ((this[0] && this[0].ownerDocument) || av).createTextNode(bv)
              );
        },
        null,
        e,
      ...
      return b.access(
        ...
        function (by) {
          ...
          if (
            typeof by === "string" &&
            !ae.test(by) &&
            (b.support.leadingWhitespace || !ar.test(by)) &&
            !ax[(d.exec(by) || ["", ""])[1].toLowerCase()]
          ) {
            by = by.replace(R, "<$1></$2>");
            try {
              for (; bw < bv; bw++) {
        ...
        if (bv.length) {
          b.each(bv, function (bG, bH) {
            if (bH.src) {
              ...
              b.globalEval(
                (bH.text || bH.textContent || bH.innerHTML || "").replace(
                  aO,
                  "/*$0*/"
                )
              );
          ...
          if (!W.test(bG)) {
            ...
            if (!b.support.tbody) {
              var by = v.test(bG),
                e =
                  bN === "table" && !by
                    ? bB.firstChild && bB.firstChild.childNodes
                    : bz[1] === "<table>" && !by
                    ? bB.childNodes
                    : [];
  ...
  b.fn.css = function (e, bv) {
    if ($(this).is("#layer443839A4830191257A65F2E96470A9D0")) {
      console.log(e, bv);
      console.trace();
    }
    return b.access(
  ...
  b.extend({
    ...
    style: function (bx, bw, bD, by) {
      ...
      if ($(bx).is("#layer8E786237F92D3E1D5D1896319EC165AD .fileicon")) {
        console.log(bw, bD, by);
        console.trace();
      }
      var bB,
        bC,
  ...
  if (av.defaultView && av.defaultView.getComputedStyle) {
    aJ = function (bA, bw) {
      ...
      if (
        (bz = bA.ownerDocument.defaultView) &&
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || p.test(this.nodeName) || a0.test(this.type))
          );
        })
        .map(function (e, bv) {
          var bw = b(this).val();
  ...
  b.ajaxPrefilter("json jsonp", function (bD, bA, bC) {
    var bx =
      ...
      /^application\/x\-www\-form\-urlencoded/.test(bD.contentType);
    if (
      bD.dataTypes[0] === "jsonp" ||
      (bD.jsonp !== false && (t.test(bD.url) || (bx && t.test(bD.data))))
    ) {
      var bB,
  ...
  b.ajaxSettings.xhr = bd.ActiveXObject
    ? function () {
      ...
      if (bx || bx === 0) {
        ...
        for (var bv = 0, e = this.length; bv < e; bv++) {
          ...
          if (bw.style) {
            ...
            if (
              (by === "" && b.css(bw, "display") === "none") ||
              !b.contains(bw.ownerDocument.documentElement, bw)
            ) {
    ...
    if (!Q[bx]) {
      ...
      if (bw === "none" || bw === "") {
        ...
        if (!m || !ba.createElement) {
          ...
          m.write(
            (b.support.boxModel ? "<!doctype html>" : "") + "<html><body>"
          );
          m.close();
        }
          ...
          function (by, bB, bA) {
            ...
            if (bA === L) {
              return bz
                ? bv in bz
                  ? bz[bv]
                  : (b.support.boxModel && bz.document.documentElement[bB]) ||
                    bz.document.body[bB]
                : by[bB];
            }
            if (bz) {
              bz.scrollTo(
                !e ? bA : b(bz).scrollLeft(),
                e ? bA : b(bz).scrollTop()
              );
            } else {
              by[bB] = bA;
  ...
  b.each({ Height: "height", Width: "width" }, function (bw, bx) {
    ...
    b.fn["inner" + bw] = function () {
      ...
      return bz
        ? bz.style
          ? parseFloat(b.css(bz, bx, "padding"))
          : this[bx]()
        : null;
    };
    b.fn["outer" + bw] = function (bA) {
      ...
      return bz
        ? bz.style
          ? parseFloat(b.css(bz, bx, bA ? "margin" : "border"))
          : this[bx]()
        : null;
    };
    b.fn[bx] = function (bz) {
...
(function (D, B) {
  function A(E) {
    return !D(E)
      ...
      .filter(function () {
        return (
          D.curCSS(this, "visibility") === "hidden" ||
  ...
  function C(H, I) {
    ...
    if ("area" === G) {
      var J = H.parentNode,
        E = J.name,
        F;
      if (!H.href || !E || J.nodeName.toLowerCase() !== "map") {
        return !1;
      }
      F = D("img[usemap=#" + E + "]")[0];
      return !!F && A(F);
  ...
  D.ui.version ||
    ...
    D.fn.extend({
      ...
      scrollParent: function () {
        var E;
        (D.browser.msie && /(static|relative)/.test(this.css("position"))) ||
    ...
    D.each(["Width", "Height"], function (I, F) {
      function E(L, M, K, N) {
        D.each(G, function () {
          (M -= parseFloat(D.curCSS(L, "padding" + this, !0)) || 0),
            K &&
              (M -=
                parseFloat(D.curCSS(L, "border" + this + "Width", !0)) || 0),
            N && (M -= parseFloat(D.curCSS(L, "margin" + this, !0)) || 0);
        });
        return M;
      }
      ...
      (D.fn["inner" + F] = function (K) {
        if (K === B) {
          return H["inner" + F].call(this);
        }
        return this.each(function () {
          D(this).css(J, E(this, K) + "px");
        });
      }),
        (D.fn["outer" + F] = function (K, L) {
          if (typeof K != "number") {
            return H["outer" + F].call(this, K);
          }
          return this.each(function () {
            D(this).css(J, E(this, K, !0, L) + "px");
          });
        });
    }),
    D.extend(D.expr[":"], {
      ...
      focusable: function (E) {
        return C(E, !isNaN(D.attr(E, "tabindex")));
      },
      tabbable: function (G) {
    ...
    D(function () {
      ...
      D.extend(F.style, {
        ...
        (D.support.minHeight = F.offsetHeight === 100),
        (D.support.selectstart = "onselectstart" in F),
        (E.removeChild(F).style.display = "none");
    }),
    D.extend(D.ui, {
      plugin: {
        add: function (G, H, E) {
          var F = D.ui[G].prototype;
          for (var I in E) {
            (F.plugins[I] = F.plugins[I] || []), F.plugins[I].push([H, E[I]]);
          }
        },
        call: function (I, G, H) {
          var E = I.plugins[G];
          if (!!E && !!I.element[0].parentNode) {
            for (var F = 0; F < E.length; F++) {
              I.options[E[F][0]] && E[F][1].apply(I.element, H);
            }
          }
        },
      },
      ...
      isOverAxis: function (G, E, F) {
        return G > E && G < E + F;
      },
      isOver: function (H, I, F, G, J, E) {
        return D.ui.isOverAxis(H, F, J) && D.ui.isOverAxis(I, G, E);
      },
    }));
})(jQuery);
/*
...
(function (D, B) {
  ...
  (D.widget = function (H, I, F) {
    ...
    var E = new I();
    (E.options = D.extend(!0, {}, E.options)),
      (D[G][H].prototype = D.extend(
        !0,
        E,
        {
          namespace: G,
          widgetName: H,
          widgetEventPrefix: D[G][H].prototype.widgetEventPrefix || H,
          widgetBaseClass: J,
        },
        F
      )),
      D.widget.bridge(H, D[G][H]);
  }),
    ...
    (D.Widget.prototype = {
      ...
      _trigger: function (H, I, F) {
        ...
        return !(
          (D.isFunction(E) && E.call(this.element[0], I, F) === !1) ||
    ...
    C.widget("ui.mouse", {
      ...
      _mouseInit: function () {
        ...
        this.element
          ...
          .bind("click." + this.widgetName, function (E) {
            if (!0 === C.data(E.target, D.widgetName + ".preventClickEvent")) {
      ...
      _mouseDown: function (F) {
        if (!B) {
          ...
          var D = this,
            ...
            G =
              typeof this.options.cancel == "string" && F.target.nodeName
                ? C(F.target).closest(this.options.cancel).length
                : !1;
          ...
          !0 === C.data(F.target, this.widgetName + ".preventClickEvent") &&
      ...
      _mouseMove: function (D) {
        if (C.browser.msie && !(document.documentMode >= 9) && !D.button) {
        ...
        this._mouseDistanceMet(D) &&
          ...
          ((this._mouseStarted =
            this._mouseStart(this._mouseDownEvent, D) !== !1),
        ...
        C(document)
          ...
          this._mouseStarted &&
            ...
            D.target == this._mouseDownEvent.target &&
              C.data(D.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(D));
        return !1;
      },
  ...
  B.widget("ui.draggable", B.ui.mouse, {
    ...
    _mouseCapture: function (D) {
      ...
      if (
        this.helper ||
        C.disabled ||
        B(D.target).is(".ui-resizable-handle,.ui-resizable-handle>.knob")
      ) {
        return false;
      }
    ...
    _mouseStart: function (E) {
      ...
      if (D.concernAngle) {
        ...
        this.offset = this.positionAbs = {
          left: C.left + B.parseInteger(this.element.css("left")),
          top: C.top + B.parseInteger(this.element.css("top")),
        };
      }
      this.offset = {
      ...
      if (D.concernAngle) {
        this.originalPosition.left = B.parseInteger(this.element.css("left"));
      }
    ...
    _createHelper: function (D) {
      var C = this.options;
      var E = B.isFunction(C.helper)
        ? B(C.helper.apply(this.element[0], [D]))
        : C.helper == "clone"
    ...
    _convertPositionTo: function (C, E) {
      ...
      return {
        top:
          E.top +
          this.offset.relative.top * H +
          this.offset.parent.top * H -
          (B.browser.safari &&
        ...
        left:
          E.left +
          this.offset.relative.left * H +
          this.offset.parent.left * H -
          (B.browser.safari &&
          B.browser.version < 526 &&
          this.cssPosition == "fixed"
            ? 0
      ...
      if (this.originalPosition) {
        ...
        if (this.containment) {
          if (this.relative_container) {
            ...
            J = [
              this.containment[0] + F.left,
              this.containment[1] + F.top,
              this.containment[2] + F.left,
              this.containment[3] + F.top,
            ];
          } else {
            J = this.containment;
          }
        ...
        if (K.grid) {
          var D = K.grid[1]
            ? this.originalPageY +
              Math.round((H - this.originalPageY) / K.grid[1]) * K.grid[1]
            : this.originalPageY;
          H = J
            ? !(
                D - this.offset.click.top < J[1] ||
                D - this.offset.click.top > J[3]
              )
              ? D
              : !(D - this.offset.click.top < J[1])
              ? D - K.grid[1]
          ...
          var E = K.grid[0]
            ? this.originalPageX +
              Math.round((I - this.originalPageX) / K.grid[0]) * K.grid[0]
            : this.originalPageX;
          I = J
            ? !(
                E - this.offset.click.left < J[0] ||
                E - this.offset.click.left > J[2]
              )
              ? E
              : !(E - this.offset.click.left < J[0])
              ? E - K.grid[0]
  ...
  B.ui.plugin.add("draggable", "scroll", {
    ...
    drag: function (G, C) {
      ...
      if (
        ...
        if (!E.axis || E.axis != "x") {
          if (
            D.overflowOffset.top + D.scrollParent[0].offsetHeight - G.pageY <
            E.scrollSensitivity
          ) {
        ...
        if (!E.axis || E.axis != "y") {
          if (
            D.overflowOffset.left + D.scrollParent[0].offsetWidth - G.pageX <
            E.scrollSensitivity
          ) {
        ...
        if (!E.axis || E.axis != "x") {
          if (G.pageY - B(document).scrollTop() < E.scrollSensitivity) {
            ...
            if (
              B(window).height() - (G.pageY - B(document).scrollTop()) <
              E.scrollSensitivity
            ) {
        ...
        if (!E.axis || E.axis != "y") {
          if (G.pageX - B(document).scrollLeft() < E.scrollSensitivity) {
            ...
            if (
              B(window).width() - (G.pageX - B(document).scrollLeft()) <
              E.scrollSensitivity
            ) {
              F = B(document).scrollLeft(
                B(document).scrollLeft() + E.scrollSpeed
  ...
  B.ui.plugin.add("draggable", "snap", {
    ...
    drag: function (O, G) {
      ...
      for (var H = L.snapElements.length - 1; H >= 0; H--) {
        ...
        if (
          !(
            (K - N < Q && Q < C + N && F - N < R && R < M + N) ||
            (K - N < Q && Q < C + N && F - N < T && T < M + N) ||
            (K - N < S && S < C + N && F - N < R && R < M + N) ||
            (K - N < S && S < C + N && F - N < T && T < M + N)
          )
        ) {
          if (L.snapElements[H].snapping) {
            L.options.snap.release &&
              L.options.snap.release.call(
                L.element,
                O,
                B.extend(L._uiHash(), { snapItem: L.snapElements[H].item })
              );
          }
        ...
        if (J.snapMode != "inner") {
          ...
          if (I) {
            G.position.top =
              L._convertPositionTo("relative", { top: M, left: 0 }).top -
              L.margins.top;
          }
          if (P) {
            G.position.left =
          ...
          if (U) {
            G.position.left =
              L._convertPositionTo("relative", { top: 0, left: C }).left -
              L.margins.left;
          }
        }
        var D = E || I || P || U;
        if (J.snapMode != "outer") {
          ...
          if (E) {
            G.position.top =
              L._convertPositionTo("relative", { top: F, left: 0 }).top -
              L.margins.top;
          }
          if (I) {
            G.position.top =
          ...
          if (P) {
            G.position.left =
              L._convertPositionTo("relative", { top: 0, left: K }).left -
              L.margins.left;
          }
          if (U) {
            G.position.left =
  ...
  B.ui.plugin.add("draggable", "wopop_snap", {
    start: function (I, D) {
      ...
      B(".ui-modselected").each(function () {
        ...
        if (B(this).data("cstlayerstatus") == "unlock") {
          F = true;
        }
      });
      if (F) {
      ...
      if (B(this).closest(".fullpagesection").length) {
        return;
      }
      ...
      B(this)
        .unbind("layersnapstart")
        .bind("layersnapstart", function () {});
      M();
    ...
    drag: function (S, G) {
      ...
      for (var H = L.snapElements.length - 1; H >= 0; H--) {
        ...
        if (T) {
          G.position.left = G.position.left + J - U;
        }
        if (Z) {
          G.position.left = G.position.left + (J - X);
        }
        if (E) {
          G.position.top = G.position.top + F - V;
        }
        if (K) {
          G.position.top = G.position.top + F - Y;
        }
        var D = E || K || T || Z;
        if (E || K || T || Z || D) {
          if (B(L.snapElements[H].item).closest(".rulerh").length) {
            B(".rulerh .rulerguide.showline").each(function () {
              ...
              if (!(Math.abs(b - d) < 0.5 || Math.abs(b - a) < 0.5)) {
                B(this).removeClass("showline");
              }
            });
          } else {
            B(".rulerv .rulerguide.showline").each(function () {
              ...
              if (!(Math.abs(c - d) < 0.5 || Math.abs(c - a) < 0.5)) {
                B(this).removeClass("showline");
              }
            });
          }
  ...
  B.ui.plugin.add("draggable", "wopop_snap2", {
    start: function (H, D) {
      ...
      function I(S) {
        ...
        var R =
          B("#canvas").offset().left - B("#scroll_container").offset().left;
        ...
        if (C(P, N) == -1) {
          N.push(P);
          var W =
            "<div class='wopop_snap_horizon wopop_snap' style='top:" +
            P +
            "px;'></div>";
        ...
        if (C(T, M) == -1) {
          M.push(T);
          var W =
            "<div class='wopop_snap_vertical wopop_snap' style='left:" +
            (R + T) +
            "px;height:" +
            Q +
            "px;'></div>";
      ...
      B(this)
        ...
        .bind("layersnapstart", function () {
          F();
          if (B.getElementAreaInf(B(this)) == "canvas") {
            B("#canvas .cstlayer:not(.ui-modselected)").each(function () {
              I(B(this));
            });
          } else {
            B("#scroll_container .cstlayer:not(.ui-modselected)").each(
              function () {
                I(B(this));
              }
            );
  ...
  B.ui.plugin.add("draggable", "stack", {
    start: function (F, C) {
      ...
      var D = B.makeArray(B(E.stack)).sort(function (I, H) {
        return (
          (parseInt(B(I).css("zIndex"), 10) || 0) -
          (parseInt(B(H).css("zIndex"), 10) || 0)
        );
      });
      if (!D.length) {
        return;
...
(function (B, A) {
  B.widget("ui.droppable", {
    ...
    _over: function (C) {
      var D = B.ui.ddmanager.current;
      !!D &&
        (D.currentItem || D.element)[0] != this.element[0] &&
    ...
    _drop: function (E, F) {
      ...
      this.element
        ...
        .each(function () {
          ...
          if (
            ...
            B.ui.intersect(
              C,
              B.extend(G, { offset: G.element.offset() }),
              G.options.tolerance
            )
          ) {
            D = !0;
      ...
      if (this.accept.call(this.element[0], C.currentItem || C.element)) {
        this.options.activeClass &&
          ...
          this.options.hoverClass &&
            this.element.removeClass(this.options.hoverClass),
          this._trigger("drop", E, this.ui(C));
        return this.element;
      }
      return !1;
    },
    ...
    B.extend(B.ui.droppable, { version: "1.8.17" }),
    (B.ui.intersect = function (L, M, P) {
      if (!M.offset) {
        return !1;
      }
      ...
      switch (P) {
        ...
        case "intersect":
          return (
            G < C + L.helperProportions.width / 2 &&
            N - L.helperProportions.width / 2 < D &&
            E < O + L.helperProportions.height / 2 &&
            F - L.helperProportions.height / 2 < J
          );
        case "pointer":
          var K =
              (L.positionAbs || L.position.absolute).left +
              (L.clickOffset || L.offset.click).left,
            H =
              (L.positionAbs || L.position.absolute).top +
              (L.clickOffset || L.offset.click).top,
            I = B.ui.isOver(
              H,
              K,
              E,
              G,
              M.proportions.height,
              M.proportions.width
            );
          return I;
        case "touch":
          return (
            ((O >= E && O <= J) || (F >= E && F <= J) || (O < E && F > J)) &&
            ((C >= G && C <= D) || (N >= G && N <= D) || (C < G && N > D))
          );
        default:
          return !1;
      }
      ...
      prepareOffsets: function (G, H) {
        ...
        droppablesLoop: for (var C = 0; C < D.length; C++) {
          if (
            ...
            (G &&
              !D[C].accept.call(D[C].element[0], G.currentItem || G.element))
          ) {
            continue;
          }
          for (var F = 0; F < I.length; F++) {
            if (I[F] == D[C].element[0]) {
          ...
          E == "mousedown" && D[C]._activate.call(D[C], H),
          ...
          B.each(B.ui.ddmanager.droppables[C.options.scope] || [], function () {
            if (!(this.options.disabled || this.greedyChild || !this.visible)) {
              ...
              if (this.options.greedy) {
                ...
                E.length &&
                  ((H = B.data(E[0], "droppable")),
                  (H.greedyChild = G == "isover" ? 1 : 0));
              }
              H &&
                G == "isover" &&
...
(function (D, B) {
  D.widget("ui.resizable", D.ui.mouse, {
    ...
    _create: function () {
      ...
      D.extend(this, {
        ...
        _helper:
          H.helper || H.ghost || H.animate
            ? H.helper || "ui-resizable-helper"
            : null,
      });
      if (
    ...
    _mouseCapture: function (G) {
      ...
      for (var F in this.handles) {
        if (D(G.target).is(".down_arrow,.up_arrow")) {
          return false;
        }
        if (
          D(this.handles[F])[0] == G.target ||
          D(this.handles[F])[0] == G.target.parentNode
        ) {
          E = true;
        }
      }
      var H = true;
      if (
        this.options.concernLock &&
        this.element.data("cstlayerstatus") == "unlock"
      ) {
        H = false;
      }
      return !this.options.disabled && E && H;
    },
    _mouseStart: function (I) {
      ...
      if (!G.concernAngle && !G.noinit) {
        if (E.is(".ui-draggable") || /absolute/.test(E.css("position"))) {
          E.css({ position: "absolute", top: H.top, left: H.left });
        }
      }
      ...
      if (D.browser.msie && D.browser.version < 9 && E.data("deg") % 360 != 0) {
        this.size = { width: E.data("IEWidth"), height: E.data("IEHeight") };
      } else {
      ...
      if (
        G.scroll &&
        (!G.concernAngle || (G.concernAngle && !this.element.data("deg")))
      ) {
      ...
      if (G.concernAngle) {
        D.divrotate.getDegreeResizeCursor(this.element);
      }
    ...
    _mouseDrag: function (H) {
      ...
      if (
        L.scroll &&
        (!L.concernAngle || (L.concernAngle && !this.element.data("deg")))
      ) {
        K += this.scrollParent.scrollTop();
      }
      ...
      if (!D.isFunction(L.aspectFunc) && (this._aspectRatio || H.shiftKey)) {
        G = this._updateRatio(G, H);
      } else {
        if (D.isFunction(L.aspectFunc)) {
          G = this._updateAFunc(G, H);
        }
      }
    ...
    _mouseStop: function (I) {
      ...
      if (this._helper) {
        ...
        var G = { width: K.helper.width() - N, height: K.helper.height() - L },
          H =
            parseInt(K.element.css("left"), 10) +
              (K.position.left - K.originalPosition.left) || null,
          J =
            parseInt(K.element.css("top"), 10) +
              (K.position.top - K.originalPosition.top) || null;
        if (!M.animate) {
          this.element.css(D.extend(G, { top: J, left: H }));
        }
    ...
    _updateAFunc: function (G, H) {
      ...
      var J = K.aspectFunc;
      if (A(G.height)) {
        G.width = J(I, G.height, "height");
      } else {
        if (A(G.width)) {
          G.height = J(I, G.width, "width");
        }
      }
      if (L == "sw") {
    ...
    _proportionallyResize: function () {
      ...
      for (var E = 0; E < this._proportionallyResizeElements.length; E++) {
        ...
        if (!this.borderDif) {
          var H = [
              J.css("borderTopWidth"),
              J.css("borderRightWidth"),
              J.css("borderBottomWidth"),
              J.css("borderLeftWidth"),
            ],
            G = [
              J.css("paddingTop"),
              J.css("paddingRight"),
        ...
        if (
          D.browser.msie &&
          !!(D(I).is(":hidden") || D(I).parents(":hidden").length)
        ) {
          continue;
        }
        J.css({
    ...
    _change: {
      e: function (I, G, E) {
        ...
        if (F.concernAngle && this.element.data("deg")) {
          return D.divrotate.getDegreeResizeChange(
            this.element,
            [G, E],
            H,
            J,
      ...
      n: function (I, G, E) {
        ...
        if (F.concernAngle && this.element.data("deg")) {
          ...
          return { top: H.top + E, height: J.height - E };
        }
      },
      s: function (I, G, E) {
        var F = this.options,
      ...
      nw: function (G, M, L) {
        ...
        return D.extend(
          this._change.n.apply(this, arguments),
          this._change.w.apply(this, [G, M, L])
        );
      },
    },
          ...
          D(M).each(function () {
            var O = D(this),
              ...
              Q =
                N && N.length
                  ? N
                  : O.parents(E.originalElement[0]).length
                  ? ["width", "height"]
    ...
    stop: function (H, G) {
      ...
      N.element.animate(D.extend(K, I && J ? { top: I, left: J } : {}), {
        ...
        step: function () {
          ...
          if (F && F.length) {
            D(F[0]).css({ width: P.width, height: P.height });
          }
          N._updateCache(P);
  ...
  D.ui.plugin.add("resizable", "containment", {
    start: function (J, G) {
      ...
      var Q = L.containment,
        O =
          Q instanceof D ? Q.get(0) : /parent/.test(Q) ? K.parent().get(0) : Q;
      if (!O) {
        return;
      }
    ...
    resize: function (K, H) {
      ...
      if (S.left < (P._helper ? J.left : 0)) {
        P.size.width =
          P.size.width +
          (P._helper ? P.position.left - J.left : P.position.left - L.left);
        if (N) {
          P.size.height = P.size.width / O.aspectRatio;
        }
        P.position.left = O.helper ? J.left : 0;
      }
      if (S.top < (P._helper ? J.top : 0)) {
        P.size.height =
          P.size.height + (P._helper ? P.position.top - J.top : P.position.top);
        if (N) {
          P.size.width = P.size.height * O.aspectRatio;
        }
      ...
      var I = Math.abs(
          (P._helper ? P.offset.left - L.left : P.offset.left - L.left) +
            P.sizeDiff.width
        ),
        E = Math.abs(
          (P._helper ? P.offset.top - L.top : P.offset.top - J.top) +
            P.sizeDiff.height
        );
      ...
      if (I + P.size.width >= P.parentData.width) {
        P.size.width = P.parentData.width - I;
        if (N) {
          P.size.height = P.size.width / P.aspectRatio;
        }
      }
      if (E + P.size.height >= P.parentData.height) {
        P.size.height = P.parentData.height - E;
        if (N) {
    ...
    stop: function (I, F) {
      ...
      if (M._helper && !K.animate && /relative/.test(N.css("position"))) {
        D(this).css({ left: E.left - J.left - H.left, width: G, height: L });
      }
      if (M._helper && !K.animate && /static/.test(N.css("position"))) {
        D(this).css({ left: E.left - J.left - H.left, width: G, height: L });
      }
    },
  });
  D.ui.plugin.add("resizable", "scroll", {
    start: function (G, E) {
      ...
      if (
        o.scroll &&
        (!o.concernAngle || (o.concernAngle && !F.element.data("deg")))
      ) {
        F.scrollout = 1;
        if (
    ...
    resize: function (G, F) {
      ...
      if (
        I.scroll &&
        (!I.concernAngle || (I.concernAngle && !J.element.data("deg")))
      ) {
        if (
          J.scrollParent[0] != document &&
          J.scrollParent[0].tagName != "HTML"
        ) {
          ...
          if ((J.axis == "s" || J.axis == "n") && H - J.size.height != 0) {
            ...
            if (
              J.overflowOffset.top + J.scrollParent[0].offsetHeight - G.pageY <
              I.scrollSensitivity
            ) {
  ...
  D.ui.plugin.add("resizable", "grid", {
    resize: function (I, F) {
      ...
      var H =
          Math.round((E.width - O.width) / (K.grid[0] || 1)) * (K.grid[0] || 1),
        G =
          Math.round((E.height - O.height) / (K.grid[1] || 1)) *
          (K.grid[1] || 1);
      if (/^(se|s|e)$/.test(N)) {
  ...
  D.ui.plugin.add("resizable", "wopop_snap", {
    start: function (J, F) {
      ...
      if (!D(this).is(".cstlayer")) {
        return;
      }
      if (D(this).closest(".fullpagesection").length) {
        return;
      }
      if (!D(".rulerh:visible").length) {
        return;
      }
    ...
    resize: function (e, H) {
      ...
      for (var K = P.snapElements.length - 1; K >= 0; K--) {
        ...
        if (Y) {
          ...
          if (D(P.snapElements[K].item).closest(".rulerh").length) {
            D(".rulerh .rulerguide").removeClass("showline");
          } else {
            D(".rulerv .rulerguide").removeClass("showline");
          }
  ...
  D.ui.plugin.add("resizable", "wopop_snap2", {
    start: function (I, F) {
      ...
      function J(T) {
        ...
        var S =
          D("#canvas").offset().left - D("#scroll_container").offset().left;
      ...
      D(this)
        ...
        .bind("layersnapstart", function () {
          G();
          if (D.getElementAreaInf(D(this)) == "canvas") {
            D("#canvas .cstlayer:not(.ui-modselected)").each(function () {
              J(D(this));
            });
          } else {
            D("#scroll_container .cstlayer:not(.ui-modselected)").each(
              function () {
                J(D(this));
              }
            );
    ...
    resize: function (e, H) {
      ...
      for (var K = P.snapElements.length - 1; K >= 0; K--) {
        ...
        if (Y) {
          P.snapElements[K].snapping = true;
          if (D(P.snapElements[K].item).is(".wopop_snap_vertical")) {
            D(".wopop_snap_vertical").removeClass("showline");
          } else {
            D(".wopop_snap_horizon").removeClass("showline");
          }
          D(P.snapElements[K].item).addClass("showline");
        } else {
          P.snapElements[K].snapping = false;
...
(function (C, A) {
  ...
  C.widget("ui.slider", C.ui.mouse, {
    ...
    _create: function () {
      ...
      for (var H = F.length; H < D; H += 1) {
        G.push(J);
      }
      (this.handles = F.add(C(G.join("")).appendTo(I.element))),
        ...
        this.handles.each(function (K) {
          C(this).data("index.ui-slider-handle", K);
        }),
        this.handles
          .keydown(function (L) {
            var M = !0,
    ...
    _mouseCapture: function (J) {
      ...
      (this.elementSize = {
        ...
        (N = { x: J.pageX, y: J.pageY }),
        (D = this._normValueFromMouse(N)),
      ...
      (this._mouseSliding = !0),
        ...
        (F = M.offset()),
        (I = !C(J.target).parents().andSelf().is(".ui-slider-handle")),
        (this._clickOffset = I
          ? { left: 0, top: 0 }
          : {
              left: J.pageX - F.left - M.width() / 2,
              top:
                J.pageY -
                F.top -
                M.height() / 2 -
        ...
        this.handles.hasClass("ui-state-hover") || this._slide(J, H, D),
        (this._animateOff = !0);
      return !0;
    },
    _mouseStart: function (D) {
    ...
    values: function (F, G) {
      ...
      if (arguments.length > 1) {
        ...
        for (H = 0; H < D.length; H += 1) {
          (D[H] = this._trimAlignValue(E[H])), this._change(null, H);
        }
        this._refreshValue();
      }
    },
    _setOption: function (F, G) {
      var D,
        E = 0;
      C.isArray(this.options.values) && (E = this.options.values.length),
    ...
    _values: function (G) {
      var E, F, D;
      if (arguments.length) {
        (E = this.options.values[G]), (E = this._trimAlignValue(E));
        return E;
      }
      F = this.options.values.slice();
      for (D = 0; D < F.length; D += 1) {
        F[D] = this._trimAlignValue(F[D]);
      }
      return F;
    },
    ...
    _refreshValue: function () {
      ...
      this.options.values && this.options.values.length
        ? this.handles.each(function (O, N) {
            (K =
              ((M.values(O) - M._valueMin()) /
                (M._valueMax() - M._valueMin())) *
              100),
              (L[M.orientation === "horizontal" ? "left" : "bottom"] = K + "%"),
              C(this).stop(1, 1)[D ? "animate" : "css"](L, J.animate),
              M.options.range === !0 &&
                (M.orientation === "horizontal"
                  ? (O === 0 &&
                      M.range
                        .stop(1, 1)
                        [D ? "animate" : "css"]({ left: K + "%" }, J.animate),
                    O === 1 &&
                      M.range[D ? "animate" : "css"](
                        { width: K - G + "%" },
                        { queue: !1, duration: J.animate }
                      ))
                  : (O === 0 &&
                      M.range
                        .stop(1, 1)
                        [D ? "animate" : "css"]({ bottom: K + "%" }, J.animate),
                    O === 1 &&
                      M.range[D ? "animate" : "css"](
                        { height: K - G + "%" },
                        { queue: !1, duration: J.animate }
        ...
        : ((H = this.value()),
          ...
          (K = F !== E ? ((H - E) / (F - E)) * 100 : 0),
          (L[M.orientation === "horizontal" ? "left" : "bottom"] = K + "%"),
          this.handle.stop(1, 1)[D ? "animate" : "css"](L, J.animate),
          I === "min" &&
            this.orientation === "horizontal" &&
            this.range
              .stop(1, 1)
              [D ? "animate" : "css"]({ width: K + "%" }, J.animate),
          I === "max" &&
            this.orientation === "horizontal" &&
          ...
          I === "min" &&
            ...
            this.range
              .stop(1, 1)
              [D ? "animate" : "css"]({ height: K + "%" }, J.animate),
          I === "max" &&
            this.orientation === "vertical" &&
            this.range[D ? "animate" : "css"](
              { height: 100 - K + "%" },
...
(function (E, C) {
  ...
  (E.fn.position = function (P) {
    ...
    var K = E(P.of),
      ...
      M;
    L.nodeType === 9
      ? ((N = K.width()), (O = K.height()), (M = { top: 0, left: 0 }))
      : L.setTimeout
      ? ((N = K.width()),
        (O = K.height()),
        (M = { top: K.scrollTop(), left: K.scrollLeft() }))
      : L.preventDefault
      ? ((P.at = "left top"),
        (N = O = 0),
        (M = { top: P.of.pageY, left: P.of.pageX }))
      : ((N = K.outerWidth()), (O = K.outerHeight()), (M = K.offset())),
      ...
      P.at[0] === "right" ? (M.left += N) : P.at[0] === A && (M.left += N / 2),
      P.at[1] === "bottom" ? (M.top += O) : P.at[1] === A && (M.top += O / 2),
      (M.left += J[0]),
      (M.top += J[1]);
    return this.each(function () {
      var W = E(this),
        ...
        S = E.extend({}, M),
        Q;
      P.my[0] === "right" ? (S.left -= Y) : P.my[0] === A && (S.left -= Y / 2),
        P.my[1] === "bottom" ? (S.top -= X) : P.my[1] === A && (S.top -= X / 2),
        F.fractions ||
          ((S.left = Math.round(S.left)), (S.top = Math.round(S.top))),
        (Q = { left: S.left - T, top: S.top - U }),
        E.each(["left", "top"], function (a, Z) {
          E.ui.position[I[a]] &&
            E.ui.position[I[a]][Z](S, {
              targetWidth: N,
              targetHeight: O,
              elemWidth: Y,
              elemHeight: X,
        ...
        E.fn.bgiframe && W.bgiframe(),
        W.offset(E.extend(S, { using: P.using }));
    });
  }),
    (E.ui.position = {
      fit: {
        left: function (K, L) {
          ...
          K.left =
            J > 0
              ? K.left - J
              : Math.max(K.left - L.collisionPosition.left, K.left);
        },
        top: function (K, L) {
          var I = E(window),
            J =
              L.collisionPosition.top +
              L.collisionHeight -
              I.height() -
              I.scrollTop();
          K.top =
            J > 0
              ? K.top - J
              : Math.max(K.top - L.collisionPosition.top, K.top);
        },
      },
      flip: {
        left: function (M, N) {
          if (N.at[0] !== A) {
            var J = E(window),
              ...
              L = -2 * N.offset[0];
            M.left +=
              N.collisionPosition.left < 0 ? I + K + L : O > 0 ? I + K + L : 0;
          }
        },
        top: function (M, N) {
          if (N.at[1] !== A) {
            var J = E(window),
              ...
              L = -2 * N.offset[1];
            M.top +=
              N.collisionPosition.top < 0 ? I + K + L : O > 0 ? I + K + L : 0;
          }
        },
      },
    }),
    E.offset.setOffset ||
      ((E.offset.setOffset = function (M, N) {
        /static/.test(E.curCSS(M, "position")) &&
    ...
    (function () {
      var M = document.getElementsByTagName("body")[0],
        ...
        K,
        L;
      (P = document.createElement(M ? "div" : "body")),
        (O = {
          visibility: "hidden",
          width: 0,
          height: 0,
  ...
  D.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this.menu = D("<ul></ul>")
        ...
        .mousedown(function (J) {
          ...
          if (!D(J.target).closest(".ui-menu-item").length) {
            setTimeout(function () {
              D(document).one("mousedown", function (G) {
                if (
                  G.target !== A.element[0] &&
                  G.target !== I &&
                  !D.ui.contains(I, G.target)
                ) {
                  A.close();
                }
              });
        ...
        .menu({
          focus: function (K, L) {
            ...
            if (false !== A._trigger("focus", K, { item: J })) {
              if (/^key/.test(K.originalEvent.type)) {
                A.element.val(J.value);
              }
            }
          },
          selected: function (L, M) {
            ...
            if (false !== A._trigger("select", L, { item: N })) {
              A.element.val(N.value);
            }
          ...
          blur: function (I, J) {
            if (A.menu.element.is(":visible") && A.element.val() !== A.term) {
              A.element.val(A.term);
            }
          },
        })
    ...
    _setOption: function (B, A) {
      ...
      if (B === "appendTo") {
        this.menu.element.appendTo(
          D(A || "body", this.element[0].ownerDocument)[0]
        );
      }
    ...
    _initSource: function () {
      ...
      if (D.isArray(this.options.source)) {
        ...
        this.source = function (I, J) {
          J(D.ui.autocomplete.filter(A, I.term));
        };
      } else {
    ...
    _resizeMenu: function () {
      ...
      if (this.options.width == "auto") {
        ...
        A.outerWidth(this.options.width).css({ "overflow-x": "hidden" });
      }
    },
    _renderMenu: function (A, B) {
      var C = this;
      D.each(B, function (I, J) {
        C._renderItem(A, J);
      });
    },
  ...
  B.widget("ui.menu", {
    ...
    activate: function (J, A) {
      ...
      if (this.hasScroll()) {
        ...
        if (G < 0) {
          this.element.scrollTop(H + G);
        } else {
          if (G >= I) {
            this.element.scrollTop(H + G - I + A.height());
          }
        }
      }
      this.active = A.eq(0)
    ...
    move: function (H, G, A) {
      if (!this.active) {
        this.activate(A, this.element.children(G));
        return;
      }
      var F = this.active[H + "All"](".ui-menu-item").eq(0);
      if (F.length) {
        this.activate(A, F);
      } else {
        this.activate(A, this.element.children(G));
    ...
    nextPage: function (F) {
      if (this.hasScroll()) {
        if (!this.active || this.last()) {
          this.activate(F, this.element.children(".ui-menu-item:first"));
          return;
        }
        var G = this.active.offset().top,
          A = this.element.height(),
          H = this.element.children(".ui-menu-item").filter(function () {
            var C = B(this).offset().top - G - A + B(this).height();
            return C < 10 && C > -10;
          });
        if (!H.length) {
          H = this.element.children(".ui-menu-item:last");
        }
        this.activate(F, H);
      } else {
        this.activate(
    ...
    previousPage: function (A) {
      if (this.hasScroll()) {
        ...
        result = this.element.children(".ui-menu-item").filter(function () {
          var C = B(this).offset().top - E + F - B(this).height();
          return C < 10 && C > -10;
        });
        if (!result.length) {
    ...
    hasScroll: function () {
      return (
        this.element.height() <
        this.element[B.fn.prop ? "prop" : "attr"]("scrollHeight")
      );
    },
    select: function (A) {
  ...
  B.widget("ui.selectable", B.ui.mouse, {
    ...
    _mouseStart: function (E) {
      ...
      B(E.target)
        ...
        .each(function () {
          ...
          if (F) {
            var G =
              (!E.metaKey && !E.ctrlKey) || !F.$element.hasClass("ui-selected");
            F.$element
            ...
            F.selected = G;
            if (G) {
              C._trigger("selecting", E, { selecting: F.element });
            } else {
              C._trigger("unselecting", E, { unselecting: F.element });
            }
            return false;
    ...
    _mouseDrag: function (F) {
      ...
      this.selectees.each(function () {
        ...
        if (!K || K.element == J.element[0]) {
          return;
        }
        var L = false;
        if (I.tolerance == "touch") {
          L = !(K.left > E || K.right < C || K.top > H || K.bottom < D);
        } else {
          if (I.tolerance == "fit") {
            L = K.left > C && K.right < E && K.top > D && K.bottom < H;
          }
        }
        if (L) {
          if (K.selected) {
...
(function ($, window, document, undefined) {
      ...
      $container.bind(settings.event, function (e) {
        ...
        timer = setTimeout(function () {
          ...
          var els = elements.filter(function () {
            return (
              $(this).closest("body").length > 0 && !$(this).data("lazy-loaded")
            );
          });
          elements = els;
        }, 200);
  ...
  $.abovethetop = function (element, settings) {
    ...
    if (
      eleparwid == 0 &&
      $(element).parents().parents().attr("class") == "img_over"
    ) {
  ...
  $.leftofbegin = function (element, settings) {
    ...
    return (
      fold >=
      Math.max($(element).offset().left + $(element).width(), 2) +
        settings.threshold
    );
  };
...
(function (E, C) {
  ...
  E.math.acos = function (F) {
    var G = Math.acos(F);
    return Math.round((G * 180) / Math.PI);
  };
  E.parseInteger = function (G) {
    var F = parseInt(G);
    if (isNaN(F)) {
      return 0;
    }
  ...
  E.divrotate = function (L, G, M, F) {
    ...
    if (
      ...
      E.browser.mozilla ||
      E.browser.opera ||
      (E.browser.msie && E.browser.version == "9.0")
    ) {
      ieRotate({ degree: G, dom: L });
    }
  };
  E.fn.modattr = function (F, G) {
    if (F == "leftpos") {
    ...
    if (F == "size") {
      ...
      if (G != C) {
        this.data("prop_size", G);
      }
      return H;
    }
  };
  E.divrotate.reversePos = function (N, H, I, M) {
    var K = N[0];
    var J = N[1];
    var O = E.math.cos(H);
    var L = E.math.sin(H);
  ...
  E.divrotate.getDegreeModMaxPoint = function (F, H, J) {
    var K = F.data("deg");
    if (H == null) {
      H = [E.parseInteger(F.css("left")), E.parseInteger(F.css("top"))];
    }
    var I = F.width();
    var G = F.height();
    return E.divrotate.getDegreeModMaxPointOrigin(F, K, H, [I, G], J);
  };
  E.divrotate.getDegreeModMaxPointForRotate = function (F, K, H, J) {
    var I = F.width();
    var G = F.height();
    return E.divrotate.getDegreeModMaxPointOrigin(F, K, H, [I, G], J);
  };
  ...
  E.divrotate.getDegreeResizeChange = function (N, Y, S, K, M) {
    ...
    var I = function (a) {
      T = E.math.acos(
        (L + a * U) / (Math.sqrt(L * L + U * U) * Math.sqrt(1 + a * a))
      );
      ...
      switch (M) {
        case "n":
          ...
          if (R <= 90) {
            if (X > 0) {
              F = {
                height: Math.round(J + P),
                left: Math.round(
                  Z + P * E.math.sin(R) - (J + P) * E.math.sin(R)
                ),
                top: Math.round(H - P * E.math.cos(R)),
              };
            } else {
              if (X < 0) {
                F = {
            ...
            if (R > 270 && R < 360) {
              if (X > 0) {
                F = {
                  height: Math.round(J + P),
                  left: Math.round(Z + P * E.math.sin(R)),
                  top: Math.round(H - P * E.math.cos(R) - G * E.math.cos(R)),
                };
              } else {
                if (X < 0) {
                  F = {
              ...
              if (R > 90 && R <= 180) {
                if (X > 0) {
                  F = {
                    ...
                    top: Math.round(
                      H + P * E.math.cos(R) + (J - P) * E.math.cos(R)
                    ),
                  };
                } else {
                  if (X < 0) {
                ...
                if (R > 180 && R <= 270) {
                  if (X > 0) {
                    F = {
                      height: Math.round(J - P),
                      left: Math.round(
                        Z - P * E.math.sin(R) + G * E.math.cos(R)
                      ),
                      top: Math.round(
                        H +
                          P * E.math.cos(R) +
          ...
          if (R <= 90) {
            if (X > 0) {
              F = {
                width: G,
                height: Math.round(J - P),
                left: Math.round(Z - (J - P) * E.math.sin(R)),
                top: H,
              };
            } else {
              if (X < 0) {
            ...
            if (R > 90 && R <= 180) {
              if (X > 0) {
                F = {
                  ...
                  height: Math.round(J + P),
                  left: Math.round(
                    Z - (J + P) * E.math.sin(R) + G * E.math.cos(R)
                  ),
                  top: Math.round(H + (J + P) * E.math.cos(R)),
                };
              } else {
                if (X < 0) {
                  F = {
              ...
              if (R > 180 && R <= 270) {
                if (X > 0) {
                  F = {
                    width: G,
                    height: Math.round(J + P),
                    left: Math.round(Z + G * E.math.cos(R)),
                    top: Math.round(
                      H + (J + P) * E.math.cos(R) + G * E.math.sin(R)
                    ),
                  };
                } else {
                  if (X < 0) {
                ...
                if (R > 270 && R < 360) {
                  if (X > 0) {
                    F = {
                      ...
                      height: Math.round(J - P),
                      left: Z,
                      top: Math.round(H - G * E.math.cos(R)),
                    };
                  } else {
                    if (X < 0) {
                      F = {
        ...
        case "w":
          ...
          if (R <= 90) {
            if (X > 0) {
              F = {
                width: Math.round(G + P),
                height: J,
                left: Math.round(Z - P * E.math.cos(R) - J * E.math.sin(R)),
                top: Math.round(H - P * E.math.sin(R)),
              };
            } else {
              if (X < 0) {
                F = {
            ...
            if (R > 90 && R <= 180) {
              if (X > 0) {
                F = {
                  ...
                  top: Math.round(H - P * E.math.sin(R) + J * E.math.cos(R)),
                };
              } else {
                if (X < 0) {
                  F = {
              ...
              if (R > 180 && R <= 270) {
                if (X > 0) {
                  F = {
                    ...
                    height: J,
                    left: Math.round(
                      Z + P * E.math.cos(R) + (G - P) * E.math.cos(R)
                    ),
                    top: Math.round(
                      H +
                        P * E.math.sin(R) +
                ...
                if (R > 270 && R < 360) {
                  if (X > 0) {
                    F = {
                      width: Math.round(G - P),
                      height: J,
                      left: Math.round(Z + P * E.math.cos(R)),
                      top: Math.round(
                        H + P * E.math.sin(R) - (G - P) * E.math.cos(R)
                      ),
                    };
                  } else {
                    if (X < 0) {
            ...
            if (R > 90 && R <= 180) {
              if (X > 0) {
                F = {
                  width: Math.round(G - P),
                  height: J,
                  left: Z - J * E.math.sin(R) + (G - P) * E.math.cos(R),
                  top: H + J * E.math.cos(R),
                };
              } else {
                if (X < 0) {
                  F = {
              ...
              if (R > 180 && R <= 270) {
                if (X > 0) {
                  F = {
                    width: Math.round(G + P),
                    height: J,
                    left: Z + (G + P) * E.math.cos(R),
                    top: H + (G + P) * E.math.sin(R) + J * E.math.cos(R),
                  };
                } else {
                  if (X < 0) {
                    F = {
...
function toolbarRotate(M, T, A, P) {
  ...
  M = $(M);
  if (P.is(".propblk")) {
    var Q = M.data("toolbarsize");
  } else {
    Q = M.data("posizeblksize");
    if (T) {
      P.data("rotatedegree", T);
    }
  }
  if (!Q) {
    Q = [P.width(), P.height()];
  ...
  if ($.browser.msie && $.browser.version < 9) {
    ...
    var I =
      ...
      S +
      canv.offset().left -
      (window.MobileOffsetLeft || 0) +
      $("#" + $.getElementFatherid(M)).ab_pos_cnter("left");
    var H =
      parseInt(W) -
      $.math.cos(T) * G +
      $("#" + $.getElementFatherid(M)).ab_pos_cnter("top");
    $.divrotate(P, T, [I, H], Q);
  }
}
function modPosRotate(K, R, B) {
  ...
  K.data("deg", R);
  $(".posblk")
    .find(".posblk-position")
    .html(Math.round(U) + "," + Math.round(Q))
    .andSelf()
    .find(".posblk-deg")
    .html(K.data("deg") % 360);
  if ($.browser.msie && $.browser.version < 9) {
    ...
    var H =
      ...
      canv.offset().left -
      (window.MobileOffsetLeft || 0) +
      $("#" + $.getElementFatherid(K)).ab_pos_cnter("left");
    var G =
      $.math.sin(R) * D +
      parseInt(Q) +
      $("#" + $.getElementFatherid(K)).ab_pos_cnter("top");
  ...
  if (I == 0) {
    ...
    if (I >= 0 && I <= 90) {
      ...
      if (I > 90 && I <= 180) {
        ...
        if (I > 180 && I <= 270) {
          var B = (-1 * F * G - D * H - D) / 2 + A;
          var M = (-1 * D * G - F * H - F) / 2 + L;
        } else {
          if (I > 270 && I < 360) {
            var B = (-1 * F * G + D * H - D) / 2 + A;
            var M = (-1 * D * G + F * H - F) / 2 + L;
...
function getLeftPointProxy(B, A) {
  ...
  var F = B.data("IEWidth"),
    E = B.data("IEHeight");
  if (I >= 0 && I < 90) {
    return [Math.round(C + E * G), Math.round(D)];
  } else {
    if (I >= 90 && I < 180) {
      return [Math.round(C + E * G - F * H), Math.round(D - E * H)];
    } else {
      if (I >= 180 && I < 270) {
        return [Math.round(C - F * H), Math.round(D - E * H - F * G)];
      } else {
        if (I >= 270 && I < 360) {
          return [Math.round(C), Math.round(D - F * G)];
        }
      }
    }
  }
...
function wpfullcolumn_float(unbindFunc) {
  ...
  $(".full_column,.cstlayer")
    ...
    .each(function () {
      ...
      var currpoor =
        ($(".full_width").width() - $(".full_content").width()) / 2;
      var isinfixed = $fc_lid.attr("infixed");

      var infixed_html = $(document).data(fc_lid + "infixed_content");
      if (!infixed_html) {
        infixed_html = $fc_lid.html();
        $(document).data(fc_lid + "infixed_content", infixed_html);
      }
      var fullc_wid_bgcolor = $(document).data(fc_lid + "fullc_wid_bgcolor");
      if (!fullc_wid_bgcolor) {
        fullc_wid_bgcolor = $fc_lid.find(".full_width").css("background-color");
        $(document).data(fc_lid + "fullc_wid_bgcolor", fullc_wid_bgcolor);
      }
      var fullc_con_bgcolor = $(document).data(fc_lid + "fullc_con_bgcolor");
      if (!fullc_con_bgcolor) {
        fullc_con_bgcolor = $fc_lid
          .find(".full_content")
          .css("background-color");
        $(document).data(fc_lid + "fullc_con_bgcolor", fullc_con_bgcolor);
      }
      var fullc_hoverbgcolor = $(document).data(fc_lid + "fullc_hoverbgcolor");
      if (!fullc_hoverbgcolor) {
        fullc_hoverbgcolor = $fc_lid.attr("zindextopcolor");
        $(document).data(fc_lid + "fullc_hoverbgcolor", fullc_hoverbgcolor);
      }
      var fullc_hoverbgcolorSet = $(document).data(
        fc_lid + "fullc_hoverbgcolorSet"
      );
      ...
      if (isinfixed == 1) {
        ...
        var oPos_tmp = $(document).data(
          "fixed_" + $(this).attr("id") + "_oPos"
        );
        var inbuttom = $(document).data(
          "fixed_" + $(this).attr("id") + "_inbuttom"
        );
        if (!oPos_tmp) {
        ...
        if (inbuttom > 0) {
          ...
          if (nPos > oPos) {
            ...
            if (wp_layer_abs_footer.is(".cstlayer")) {
              newleft =
                wp_layer_abs_footer.offset().left + $(container).scrollLeft();
            ...
            if (wp_layer_abs_footer.length > 0) {
              ...
              wp_layer_fix = wp_layer_abs_footer
                .clone(true)
                .appendTo(container)
              ...
              if (wp_layer_abs_footer.attr("fatherid"))
                wp_layer_fix.attr("fatherid", wp_layer_abs.attr("fatherid"));
              wp_layer_fix.show();
              wp_layer_fix.css({
                position: "fixed",
                top: "",
            ...
            if (fullc_hoverbgcolorSet) {
              wp_layer_fix
                .find(".full_width")
                .css({
                  "background-color": fullc_hoverbgcolor,
                  transition: "1.2s",
                });
              wp_layer_fix
                .find(".full_content")
                .css({ "background-color": "", transition: "1.2s" });
            }
          } else {
            ...
            if (wp_layer_abs_footer.length == 0) {
              ...
              wp_layer_abs_footer = wp_layer_fix
                .clone(true)
                .appendTo(wp_icontent_foot)
                .attr("fc_fh_istop", "")
                .attr("style", oldstyle)
                .attr("inbuttom", "1")
                .removeClass("full_column-fixed");
              if (wp_layer_fix.attr("fatherid")) {
                wp_layer_abs_footer.attr(
                  "fatherid",
                  wp_layer_fix.attr("fatherid")
                );
              }
            ...
            if (fullc_hoverbgcolorSet) {
              wp_layer_fix
                .find(".full_width")
                .css("background-color", fullc_wid_bgcolor);
              wp_layer_fix
                .find(".full_content")
                .css("background-color", fullc_con_bgcolor);
            }
          }
        } else {
          if (nPos > oPos) {
            var newleft = Math.abs(
              parseFloat($(".full_column").find(".full_width").css("left"))
            );
            ...
            $(document).data(
              "fixed_" + wp_layer_abs.attr("id") + "_father",
              $("#" + fatherid)
            );
            ...
            if (wp_layer_abs.length > 0) {
              ...
              var func = function () {
                ...
                var success = true;
                var newleft = Math.abs(
                  parseFloat($(fc_lid).find(".full_width").css("left"))
                );
                if (!newleft) {
                  success = false;
                }
              ...
              var layerdiv = $("<div/>").attr({
                ...
                zindextopcolorset: wp_layer_abs.attr("zindextopcolorset"),
              });
              if (wp_layer_abs.attr("fatherid"))
                layerdiv.attr("fatherid", wp_layer_abs.attr("fatherid"));
              container.append(layerdiv);
              wp_layer_abs.remove();
              var wp_layer_fix = $(fc_lid)
                .html(infixed_html)
                .attr("oldstyle", oldstyle)
                .attr("fc_fh_istop", 1)
                .addClass("full_column-fixed");
              ...
              $(".full_content img.img_lazy_load").lazyload({
                ...
                failure_limit: $("img.img_lazy_load").length,
                container: imgcontainer,
                placeholder: relativeToAbsoluteURL(
                  "template/default/images/blank.gif"
                ),
                load: function () {
                  var self = $(this);
                  var id = self.closest(".cstlayer").prop("id");
                  if (window["set_thumb_" + id])
                    window["set_thumb_" + id](this);
                },
              });
            } else {
              if (is_mobile_preview) {
            ...
            if (!wp_layer_abs.length > 0) {
              var layerdiv = $("<div/>").attr({
                ...
                zindextopcolor: wp_layer_fix.attr("zindextopcolor"),
                zindextopcolorset: wp_layer_fix.attr("zindextopcolorset"),
              });
              if (wp_layer_fix.attr("fatherid"))
                layerdiv.attr("fatherid", wp_layer_fix.attr("fatherid"));
              wp_icontent = $(document).data(
                "fixed_" + wp_layer_fix.attr("id") + "_father"
              );
      ...
      $(".full_column,.cstlayer")
        ...
        .each(function () {
          ...
          if (self.parent().is("#canvas") && parseInt(self.css("top")) == 0) {
            ...
            if (self.is(".cstlayer")) {
              newleft =
                self.offset().left + $("#scroll_container").scrollLeft();
              if (is_mobile_preview) {
            ...
            if ($multilingual.get(0) != "undefined") {
              var $multilingual_content = $multilingual.find(
                ".wp-content > .overz"
              );
            ...
            wp_layer_fix
              .find(".cstlayer[type=weibofollowbutton]")
              .each(function () {
                var code = $(this).data("wpcode");
      ...
      $(document).bind(
        ...
        function (e) {
          ...
          var $target = $(e.target).closest(
            '.full_column[infixed="1"],.cstlayer[infixed="1"]'
          );
          if ($target.length > 0) {
...
function initCanvasHeight() {
  ...
  var helperfunc = function (dom) {
    ...
    if (dom.hasClass("cstlayer")) {
      var buttompos = $.divrotate.getDegreeModMaxPointOrigin(
        dom,
        degree,
        pos,
        [w, h],
    ...
    if (dom.data("wopop_effect_oristyle")) {
      ...
      if (topmatches) {
        ...
        if (
          domfatherid &&
          domfatherid != "canvas" &&
          domfatherid != "site_footer" &&
          $("#" + domfatherid).length
        ) {
          buttompos =
            oritop + dom.height() + $("#" + domfatherid).ab_pos("top");
        }
      }
    }
    return buttompos;
  ...
  var filterfunc = function () {
    return (
      $(this).is(":not(div[deleted='deleted'])") &&
      $(this).attr("childdel") != "del"
    );
  };
  $("#canvas  .cstlayer,#canvas  .full_column")
    .filter(filterfunc)
    .each(function () {
  ...
  setTimeout(function () {
    $("#site_footer")
      ...
      .each(function () {
        ...
        if (thistop < 0 && sitetop < -thistop) {
          $(this).css("top", -sitetop);
        }
      });
  }, 100);
}
...
function fullcolumn_HoverInit(params) {
  ...
  if (params.full.hover) {
    $("body")
      .on("mouseover", "#" + params.full.id + " .full_width", function (e) {
        $("#" + params.full.id + " .full_width").css({
          "background-color": params.full.hover,
          opacity: params.full.opacity,
        });
      })
      .on("mouseout", "#" + params.full.id + " .full_width", function (e) {
        if (params.full.bgopacity) {
          thisFHopacity = params.full.bgopacity;
        } else {
          thisFHopacity = "";
        }
        var parfbg = "";
        ...
        $("#" + params.full.id + " .full_width").css({
          "background-color": parfbg,
          opacity: thisFHopacity,
        });
      });
    if (params.full_con.hover == "transparent") {
      $("#scroll_container")
        .on("mouseover", "#" + params.full.id + " .full_content", function (e) {
          $("#" + params.full.id + " .full_content").css({
            "background-color": params.full.hover,
            opacity: params.full.opacity,
          });
        })
        .on("mouseout", "#" + params.full.id + " .full_content", function (e) {
          $("#" + params.full.id + " .full_content").css({
            "background-color": params.full.bg,
            opacity: "1",
          });
        });
    }
  ...
  if (params.full_con.hover || params.full.hover) {
    $("body")
      .on(
        "mouseover",
        "#" + params.full_con.id + " .full_content",
        function (e) {
          var fc_opacity = params.full_con.opacity
            ? params.full_con.opacity
            : "";
          if (fc_opacity == 0) fc_opacity = "";
          $("#" + params.full_con.id + " .full_content").css({
            "background-color": params.full_con.hover,
            opacity: fc_opacity,
          });
          $("#" + params.full.id + " .full_width").css({
            "background-color": params.full.hover,
      ...
      .on(
        ...
        function (e) {
          ...
          if ($(fc_lid).attr("fc_fh_istop") && zindextopColorSet) {
            ...
            parfcbg = params.full_con.bg;
            parfbg1 = params.full.bg;
          }
          $("#" + params.full_con.id + " .full_content").css({
            "background-color": parfcbg,
            opacity: "",
          });
          if (params.full.bgopacity)
            thisFHopacity = params.full.bgopacity ? params.full.bgopacity : "";
          $("#" + params.full.id + " .full_width").css({
            "background-color": parfbg1,
            opacity: thisFHopacity,
          });
        }
      );
      ...
      if (history && history.pushState) {
        ...
        if (!is_layer_add[layerid] && pageid != init_pageinfo[layerid]) {
          history.replaceState(
            { action: "page", layerid: layerid, page: init_pageinfo[layerid] },
            document.title,
            loc
          );
        ...
        history.pushState(
          { action: "page", layerid: layerid, page: pageid },
          document.title,
          newloc
        );
      }
...
(function () {
  function resizeCanvasHeight() {
    ...
    // 画布高度
    var cvhgt =
      window.getdeviceheight ||
      window.innerHeight ||
      self.innerHeight ||
      document.documentElement.clientHeight ||
      document.body.clientHeight; //$(window).height();
    var ua = /micromessenger/i.test(navigator.userAgent.toLowerCase());
    if (window.isHandheld && !ua)
      cvhgt = Math.min(cvhgt, MobileUtils.getScreenHeight());
    ...
    if ($("#site_footer").length > 0) {
      var canvheight = Math.max(
        $("#canvas").data("layermaxheight"),
        cvhgt - $("#site_footer").height() - mfooterheight
      );
      ...
      canvheight = Math.max(
        $("#canvas").data("layermaxheight"),
        cvhgt - mfooterheight
      ); //没有页脚时去设备底部高度，防没有任何模块时有滚动条bug/4574
    }
    ...
    if (typeof $.fn.ruler_locate != "undefined") {
      $.fn.ruler_locate({
        ...
        y: {
          ...
          left: (canvleft > 17 ? canvleft - 17 : 0) + "px",
        },
      });
    ...
    if (window.isHandheld) {
      var $container = $("#scroll_container"),
        ...
        maxheight =
          $("#scroll_container_bg").height() +
          $(">.mblank_placeholder", $container).height();
  ...
  function correctFooterPos() {
    ...
    if (window.isHandheld) {
      ...
      $("#scroll_container").css(
        "height",
        $("#scroll_container").height() - 1 + "px"
      );
      $("#scroll_container_bg").css(
        "height",
        $("#scroll_container_bg").height() - 1 + "px"
      );
    ...
    if ($("#wp-mobile-device-header").length > 0) {
      ...
      $(window).load(function () {
        ...
        var mprevtimer = setTimeout(function () {
          ...
          // 模拟“触屏”模式
          var maxtop =
            frmheight - $(".wp-mobile-prescrollbar > span.pane").height();
          ...
          $scontainer.bind("mousedown.mbprevredhat", function (e) {
            ...
            $scontainer
              .bind("mousemove.tmpredhat", function (e) {
                e.preventDefault();
            ...
            $(parent.document).bind("mouseup.rmredhat", function () {
              $scontainer.unbind(".tmpredhat");
              hidebar();
            });
          });
    ...
    if (e.target == window || e.target == document) {
      setTimeout(function () {
        ...
        if ($(".full_column-fixed:not(.cstlayer)").length) {
          var full_column_left =
            0 - $(".full_column-fixed>.full_width").position().left;
...
function wp_pages_global_func(params) {
  ...
  window["getSiteCurLang"] = function () {
    return params["interface_locale"];
  };
  window["getPreviewSiteCurLang"] = function () {
    return params["curr_locale"];
  };
  window["getSystemCurrentDomain"] = function () {
    return uname;
  };
  window["isSiteDevMode"] = function () {
    return params["dev_mode"] == "1" ? true : false;
  };
  ...
  window["getWebSiteType"] = function () {
    return $.trim(params["mscript_name"] || "").length > 0 ? "mobile" : "pc";
  };
  window["getSystemSession"] = function () {
...
function wp_confirm(message, callback, cancelBack) {
  ...
  var width = 286,
    pnl = "",
    ol = '<div id="wp-confirmpnl_overlay"></div>';
  pnl =
    '<div id="wp-confirm_panel" class="overz wp-manage_panel wp-alert-panel" style="position:absolute;width:' +
    width +
    'px;z-index:10001;">' +
    '<div class="wp-panel_outpadding overz"><div class="wp-manage_panel_block_one wp-manage-link overz"><h2 class="overz">' +
    message +
    "</h2></div>" +
    '<div class="wp-alert_button overz"><a href="javascript:;" class="wp-alert-sure">' +
    translate("Sure") +
    '</a><a href="javascript:;" class="wp-alert-cancel">' +
    translate("Cancel") +
    "</a></div></div></div>";
  ...
  $cpnl.bind("rename", function (e, name) {
    if (name.length) {
      ...
      if (name.match(/,/)) {
        var btnstr =
          '<a href="javascript:;" class="wp-alert-sure">' +
          translate("Sure") +
          '</a><a href="javascript:;" style="margin-right:10px" class="wp-alert-edit">' +
          translate("Edit") +
          '</a><a href="javascript:;" class="wp-alert-cancel">' +
          translate("Cancel") +
          "</a>";
        //var str_edit =  $('.wp-manage-link',self).html();
        var page = message.match(
        ...
        $("a.wp-alert-edit", self).css(
          "background",
          "url(../images/wp-button-black-bg.gif) repeat-x #383838"
        );
        $("a.wp-alert-edit", self).hover(function () {
          $("a.wp-alert-sure", self).css(
            "background",
            "url(../images/wp-button-black-bg.gif) repeat-x #383838"
          );
          $("a.wp-alert-edit", self).css({
            color: "#FFF",
            background:
              "url(../images/wp-button-bg-hover.gif) repeat-x #366bbc",
          });
          $("a.wp-alert-cancel", self).css(
            "background",
            "url(../images/wp-button-black-bg.gif) repeat-x #383838"
          );
        });
        ...
        var timerid = setTimeout(function () {
          var newidth =
            $("a.wp-alert-edit", self).outerWidth(true) +
            $("a.wp-alert-sure", self).outerWidth(true) +
            $("a.wp-alert-cancel", self).outerWidth(true);
          $(".wp-alert_button", self).width(newidth);
          newidth = null;
          clearTimeout(timerid);
        }, 50);
        // 绑定"OK|Cancel"按钮
        $cpnl
          .find("a.wp-alert-sure")
          .click(function (e) {
...
function wp_editPicOnline(param) {
  ...
  $LAB
    .script(relativeToAbsoluteURL("script/wopop2_" + imgtypestr + ".js"))
    .wait(function () {
...
function wp_viewPicOnline(param) {
  $LAB
    .script(relativeToAbsoluteURL("script/wopop2_preview.js"))
    .wait(function () {
...
function wp_alert(message, callback) {
  ...
  var width = 286,
    pnl = "",
    ol = '<div id="wp-alertpnl_overlay"></div>';
  pnl =
    '<div id="wp-alert_panel" class="overz wp-manage_panel wp-alert-panel" style="position:absolute;width:' +
    width +
    'px;z-index:10001;">' +
    '<div class="wp-panel_outpadding overz"><div class="wp-manage_panel_block_one wp-manage-link overz"><h2 class="overz">' +
    message +
    "</h2></div>" +
    '<div class="wp-alert_button overz" style="width:55px;"><a href="javascript:;" class="wp-alert-sure">' +
    translate("Sure") +
    "</a></div></div></div>";
  $(ol + pnl).appendTo("body");
      ...
      if (opentype == "iframe") {
        $data.html(
          '<iframe src="' +
            ...
            '" frameborder="0" width="' +
            width +
            '" onload="this.height=this.contentWindow.document.documentElement.scrollHeight" scrolling="no"></iframe>'
        );
        d.overlay.show();
        $data.show();
        ...
        $container
          .fadeTo("fast", 1)
          .draggable({ handle: "#osx-modal-title", cursor: "move" });
      } else {
        var $ajaxload = $("#wp-ajaxsend_loading2"),
          $win = $(window);
        if ($ajaxload.size() == 0)
          $(
            '<div id="wp-ajaxsend_loading2" style="width:' +
              $win.width() +
              "px;height:" +
              $win.height() +
              'px;z-index:9999;"><img src="' +
              relativeToAbsoluteURL("template/default/images/loading.gif") +
...
function get_plugin_css(tagid, css) {
  ...
  tempcss = tempcss.replace(/&gt;/gi, ">");
  if (editmode) $("#page_set_css").html("<style> " + tempcss + "</style>");
  else {
    $("#page_set_css").after(
      $("#page_set_css")
        .clone()
        .attr("id", "page_set_css2")
        .html("<style> " + tempcss + "</style>")
    );
...
(function ($, undefined) {
  ...
  function initPropCommand() {
    ...
    PropertyCommand = Undo.Command.createModuleCommand(
      function (blockid, val) {
        var blockel = $("#" + blockid);
        if (val.propval != undefined)
          blockel.mod_property(val.propkey, val.propval);
  ...
  function initPropCommand2() {
    ...
    PropertyCommand2 = Undo.Command.createModuleCommand(
      function (blockid, val) {
        var blockel = $("#" + blockid);
  ...
  $.fn.autoundo_mod_property2 = function (val) {
    ...
    if (!Undo.Command.DefaultEqAct(oldval, val))
      new PropertyCommand2(this.attr("id")).insertWithVals(oldvalue, newvalue);
  };
  ...
  $.fn.autoundo_mod_property = function (key, val) {
    ...
    if (!Undo.Command.DefaultEqAct(oldval, val))
      new PropertyCommand(this.attr("id")).insertWithVals(oldvalue, newvalue);
  };
...
function footerdrag() {
  ...
  var Command = Undo.Command.createModuleCommand(
    function (blockid, val) {
      var blockel = $("#" + blockid);
      ...
      $("#scroll_container_bg").css(
        "height",
        val.canvheight + blockel.height() + "px"
      );
      $.updateselectbgopt();
      $.updatepospropblk();
      $.canvasHeightChange();
  ...
  $("#site_footer").draggable({
    ...
    drag: function (event, ui) {
      ...
      if (topmovepx < 0) {
        ...
        if (delta > maxminusheight) {
          ...
          $("#scroll_container_bg").css(
            "height",
            canvasminheight + $(this).height() + 100 + "px"
          );
          ...
          $(".posizeblk")
            .html(
              "x:" +
                (parseFloat($(this).css("left")) || 0) +
                ", y:" +
                ui.position.top
            )
            .show();
          $(this).triggerHandler("drag_progress", [
            { left: 0, top: ui.position.top },
          ]);
      ...
      $("#scroll_container_bg").css(
        "height",
        curcanvheight + topmovepx + $(this).height() + 100 + "px"
      );
      ui.originalPosition.top = oriPosTop;
    },
    stop: function (event, ui) {
      ...
      undoobj.insertWithNewVal({
        top: $.parseInteger($(this).css("top")),
        canvheight: curcanvheight + topmovepx,
      });
      undoobj = null;
      $(".bgblk").show();
      $(".posizeblk").hide();
  ...
  dom.resizable({
    ...
    resize: function (event, ui) {
      ...
      if ($.getElementAreaInf($(this)) == "canvas") {
        var maxbuttom = Math.max(
          curtop + fullcolumnbuttompos,
          curtop + curheight
        );
        $.canvasheightresizeOrigin(maxbuttom);
      }
      $(this)
        .find(".fullwidth_vdiv,.fullwidth_bg,.fullwidth_video")
        .height($(this).height());
      ...
      $(".bgblk").hide();
      $(".posizeblk")
        .html("W:" + $(this).width() + ", H:" + $(this).height())
        .show();
    },
    stop: function (event, ui) {
      $(this)
  ...
  $("#site_footer").resizable({
    ...
    resize: function (event, ui) {
      ...
      if (theaxis == "n") {
        ...
        $("#scroll_container_bg").css(
          "height",
          canv.height() + $(this).height() + 100 + "px"
        );
      } else {
        $(this).children(".full_content,.full_width").height($(this).height());
        $("#scroll_container_bg").css(
...
function fullcolumndrop(dom) {
  ...
  contentblock
    .children(".placeholder-n")
    .css({ "border-top": "#FF9900 dashed 4px" });
  contentblock
    .children(".placeholder-s")
    .css({ "border-bottom": "#FF9900 dashed 4px" });
  contentblock
    .children(".placeholder-e")
    .css({ "border-right": "#FF9900 dashed 4px" });
  contentblock
    .children(".placeholder-w")
    .css({ "border-left": "#FF9900 dashed 4px" });
  ...
  contentblock.droppable({
    ...
    drop: function (event, ui) {
      ...
      if (
        $.getElementAreaInf($(draggable.element)) == $.getElementAreaInf(dom)
      ) {
      ...
      if (false) {
        ...
        switch (curkey) {
          case "bg_moveto_prevop":
            lvtype = "top";
            innertxt =
              '<div class="wp-moveto_fstlevel"><a class="property-bar-top" href="###" title="' +
          ...
          case "bg_moveto_nextop":
            lvtype = "bottom";
            innertxt =
              '<div class="wp-moveto_lstlevel"><a class="property-bar-bottom" href="###" title="' +
...
(function ($) {
  ...
  $.chooseBiggerColumn = function (existcolumnid, newcolumnid) {
    ...
    if (existcolumnid) {
      ...
      if (existdifffather == "null") biggercolumnid = newcolumnid;
        ...
        var existfatherzindex = $.parseInteger(
          $("#" + existdifffather).css("z-index")
        );
        var newfatherzindex = $.parseInteger(
          $("#" + newdifffather).css("z-index")
        );
  ...
  $.transferToColumn = function (dom, fathercolid) {
    ...
    if (oldfatherid != fathercolid) {
      ...
      dom
        .detach()
        .attr("fatherid", fathercolid)
        .css({ top: domabpos - newfatherabpos, left: domableft - newfatherl })
        .appendTo(contentblock);
      if (fathercolid == "site_footer" || fathercolid == "canvas")
  ...
  $.transferToArea = function (dom, from, to, isInUndo) {
    ...
    if (to == "site_footer") {
      ...
      dom
        .detach()
        .removeAttr("fatherid")
        .appendTo($("#site_footer").children(".full_content"));
      if (
        dom.hasClass("full_pagescroll") ||
        dom.hasClass("full_column") ||
        dom.hasClass("wp_droppable")
      ) {
        dom
          .find(".cstlayer,.full_pagescroll,.full_column")
          .attr("inbuttom", "1")
          .attr("data-model", "edit");
      }
    } else {
      var curmodtop = domabpos + footertop;
      dom.css("top", curmodtop);
  ...
  $.addFullColumn = function (top) {
    ...
    var successfunc = function (resp, needchangeid) {
      ...
      objarray[0] = new Array(
        parseInt($("#" + fullcolumnel.prop("id")).css("z-index")),
        fullcolumnel.prop("id")
      );
  ...
  $.getElementFatherid = function (dom) {
    if (dom.prop("id") == "canvas" || dom.prop("id") == "site_footer")
      return "none";
  ...
  $.fn.ab_pos = function (direct) {
    ...
    if (direct == "left" || direct == "top") {
      if (!dom.attr("fatherid") || dom.attr("fatherid") == "")
        return dom.rel_pos(direct);
  ...
  $.getFullColChildMaxButtom = function (dom) {
    ...
    dom.find(".cstlayer,.full_column").each(function () {
      var el = $(this);
      var buttompos = 0;
      if (el.hasClass("cstlayer"))
        buttompos = $.divrotate.getDegreeModMaxPoint(el, null, "buttom");
      else
        buttompos = el.ab_pos_cnter("top") + $.parseInteger(el.css("height"));
      ...
      dom
        ...
        .each(function () {
          ...
          if (el.hasClass("cstlayer"))
            ...
            buttompos =
              el.ab_pos_cnter("top") + $.parseInteger(el.css("height"));
          if (maxbuttompos < buttompos) maxbuttompos = buttompos;
        });
      return maxbuttompos;
    }
  ...
  $.saveFullColumnObj = function (dom) {
    var fullbackprop =
      dom.children(".full_width").data("backgroundprops") || {};
    var contentbackprop =
      dom.find(".full_content").data("backgroundprops") || {};
    ...
    if (dom.prop("id") != "site_footer") {
      ...
      otherparam = {
        top: $.parseInteger(dom.css("top")),
        zindex: $.parseInteger(dom.css("z-index")),
        lock: dom.data("cstlayerstatus"),
        fixdisplay: infixed,
        iszIndexTop: zindextop,
        zindextopcolorset: zindextopcolorset,
      };
    }
    return $.extend(
      {
  ...
  $.processDropMask = function (dom) {
    ...
    var $target = dom;
    if (
      $target.find(".ui-modselected").length ||
      $target.is(".ui-modselected")
    ) {
...
!(function () {
  ...
  var t = function (t) {
    ...
    n = function () {
      for (
        var t = document.querySelectorAll("[data-object-fit]"), e = 0;
        e < t.length;
        e++
      ) {
...
eval(
  (function (C, E, D, F, B, A) {
    B = function (G) {
      return (
        (G < E ? "" : B(parseInt(G / E))) +
        ((G = G % E) > 35 ? String.fromCharCode(G + 29) : G.toString(36))
      );
    };
    if (!"".replace(/^/, String)) {
      while (D--) {
    ...
    while (D--) {
      if (F[D]) {
        C = C.replace(new RegExp("\\b" + B(D) + "\\b", "g"), F[D]);
      }
    }
    return C;
  })(
    "F S(s){4 g=s.g;4 e=s.e;4 d=s.d;4 w=s.D;4 h=s.C;4 a=s.a;4 n=g+'n';4 k=\"M(\"+n+\")\";6($.j.Q){6($.j.T>=9){a.5('-z-c',k);a.5(\"-z-c-p\",\"b b\")}f{4 H=v.Z*g/I; 4 7=v.13(H);4 8=v.10(H);4 m=g%J;a.x('8',8);a.x('7',7);6(m>=0&&m<=K){4 t=e-((h*8+w*7)/2-w/2);4 r=d-((w*8+h*7)/2-h/2)}6(m>K&&m<=I){6(h*8+w*7*-1>w)4 t=e-((h*8+w*7*-1)/2-w/2);f 4 t=e+(w/2-(h*8+w*7*-1)/2);6((h*7*-1+w*8)>h)4 r=d-((h*7*-1+w*8)/2-h/2);f 4 r=d+(h/2-(h*7*-1+w*8)/2)}6(m>I&&m<=N){4 t=e-((-1*h*8+-1*w*7)/2-w/2);4 r=d-((-1*w*8+-1*h*7)/2-h/2)}6(m>N&&m<J){4 t=e-((w*7+h*8*-1)/2-w/2);6(-1*w*8+h*7>h)4 r=d-(-1*w*8+h*7-h)/2;f 4 r=d+(h-(-1*w*8+h*7))/2}a.5({V:\"W:X.Y.14(1b=\"+7+\",1d=\"+(-8)+\",1e=\"+8+\",1f=\"+7+\",16='15 17')\"});a.5({'e':t+'L','d':r+'L'})}}f 6($.j.P){a.5('-B-c',k);a.5(\"-B-c-p\",\"b b\")}f 6($.j.U){a.5('-A-c',k);a.5(\"-A-c-p\",\"b b\")}f 6($.j.R){a.5('-o-c',k);a.5(\"-o-c-p\",\"b b\")}}F 1a(a){a.19(F(){4 g=11($(3).i('n'))||0;$(3).x('n',g);6(g!=0){4 n=g+'n';4 k=\"M(\"+n+\")\";6($.j.U){$(3).5('-A-c',k);$(3).5(\"-A-c-p\",\"b b\")}f 6($.j.P){$(3).5('-B-c',k);$(3).5(\"-B-c-p\",\"b b\")}f 6($.j.R){$(3).5('-o-c',k);$(3).5(\"-o-c-p\",\"b b\")}f 6($.j.Q){6($.j.T>=9){$(3).5('-z-c',k);$(3).5(\"-z-c-p\",\"b b\")}f{$(3).x('1c',$(3).D()).x('12',$(3).C());4 y=[$(3).q().e,$(3).q().d],u=[];S({g:g,e:$(3).q().e,d:$(3).q().d,D:$(3).D(),C:$(3).C(),a:$(3)});u=18($(\"#\"+$(3).i('l')),g);4 G=v.O(y[0]-u[0]),E=v.O(y[1]-u[1]);6(y[0]>u[0])$(\"#\"+$(3).i('l')).5('e',$(\"#\"+$(3).i('l')).q().e+G);f $(\"#\"+$(3).i('l')).5('e',$(\"#\"+$(3).i('l')).q().e-G);6(y[1]>u[1])$(\"#\"+$(3).i('l')).5('d',$(\"#\"+$(3).i('l')).q().d+E);f $(\"#\"+$(3).i('l')).5('d',$(\"#\"+$(3).i('l')).q().d-E)}}}})}",
    62,
    78,
    "|||this|var|css|if|cosx|sinx||dom|0px|transform|top|left|else|degree||attr|browser|degp|id|angle|deg||origin|position|topNew|json|leftNew|arr1|Math||data|arr|ms|moz|webkit|height|width|relativeTop|function|relativeLeft|rotation|180|360|90|px|rotate|270|abs|safari|msie|opera|ieRotate|version|mozilla|filter|progid|DXImageTransform|Microsoft|PI|sin|parseInt|IEHeight|cos|Matrix|auto|SizingMethod|expand|getLeftPointProxy|each|rotateDom|M11|IEWidth|M12|M21|M22".split(
      "|"
    ),
    0,
    {}
...
(function (A) {
  ...
  return (function (I, G, E, A) {
    if (!I.Velocity || !I.Velocity.Utilities) {
      G.console &&
        console.log(
      ...
      function N(Q, T, P, R) {
        ...
        J.each(Q.nodeType ? [Q] : Q, function (U, V) {
          ...
          J.each(
            ...
            function (W, X) {
              S += parseFloat(B.CSS.getPropertyValue(V, X));
            }
          );
        });
        B.animate(
          ...
          { height: (T === "In" ? "+" : "-") + "=" + S },
          {
            queue: false,
            easing: "ease-in-out",
            duration: P * (T === "In" ? 0.6 : 1),
          }
        );
      }
      B.Redirects[M] = function (O, Q, T, d, P, a) {
        var U = T === d - 1;
        if (typeof L.defaultDuration === "function") {
          L.defaultDuration = L.defaultDuration.call(P, P);
        } else {
          L.defaultDuration = parseFloat(L.defaultDuration);
        }
        for (var X = 0; X < L.calls.length; X++) {
          ...
          if (X === 0) {
            ...
            if (T === 0) {
              W.begin = function () {
                Q.begin && Q.begin.call(P, P);
                var e = M.match(/(In|Out)$/);
                if (e && e[0] === "In" && S.opacity !== A) {
                  J.each(P.nodeType ? [P] : P, function (f, g) {
                    B.CSS.setPropertyValue(g, "opacity", 0);
                  });
                }
                if (Q.animateParentHeight && e) {
                  N(P, e[0], Z + W.delay, Q.stagger);
                }
              };
            }
            if (Q.display !== null) {
              if (Q.display !== A && Q.display !== "none") {
                W.display = Q.display;
              } else {
                if (/In$/.test(M)) {
            ...
            if (Q.visibility && Q.visibility !== "hidden") {
              W.visibility = Q.visibility;
            }
          }
          if (X === L.calls.length - 1) {
            function R() {
              if ((Q.display === A || Q.display === "none") && /Out$/.test(M)) {
                J.each(P.nodeType ? [P] : P, function (e, f) {
                  B.CSS.setPropertyValue(f, "display", "none");
                });
              }
            ...
            W.complete = function () {
              if (L.reset) {
                for (var e in L.reset) {
                  var f = L.reset[e];
                  if (
                    B.CSS.Hooks.registered[e] === A &&
                    (typeof f === "string" || typeof f === "number")
                  ) {
                    L.reset[e] = [L.reset[e], L.reset[e]];
                  }
                }
    ...
    for (var F in B.RegisterEffect.packagedEffects) {
      B.RegisterEffect(F, B.RegisterEffect.packagedEffects[F]);
    }
    B.RunSequence = function (M) {
      ...
      if (L.length > 1) {
        J.each(L.reverse(), function (N, R) {
          ...
          if (Q) {
            var O =
                R.options && R.options.sequenceQueue === false
                  ? "begin"
                  : "complete",
...
(function (window) {
    ...
    _getEffectDom(dom).done(function (dom) {
      ...
      dom.velocity(
        { left: orileft + "px" },
        {
          ...
          display: "block",
          easing: "ease",
          complete: create_complete(options),
        }
      );
    });
  };
  ...
  $.WOPOP_EFFECTS["frombottom"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      ...
      if ($(dom).parents(".cstlayer").attr("type") == "pop_up") {
        ...
        $(dom).css(
          "top",
          container.scrollTop() + container.height() + $(dom).height()
        );
      }
      dom.velocity(
        { top: oritop + "px" },
  ...
  $.WOPOP_EFFECTS["fromtop"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      // 考虑「通栏」元素（bug#4284）
      var $layer = $(dom),
        initop = ($layer.attr("fatherid") || "").length
          ? 0
          : container.scrollTop() - $(dom).height();
      //弹窗容器内子插件从上飞出效果调整，不影响其它插件
      if (
        $(dom).parents(".cstlayer").attr("type") == "pop_up" ||
        ($layer.attr("type") == "pop_up" && $layer.css("position") == "fixed")
      ) {
  ...
  $.WOPOP_EFFECTS["bounceIn"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      dom
        .velocity(
          { scale: [1.05, 0.3], opacity: [1, 0] },
          { delay: delay * 1000, duration: duration * 333, display: "block" }
        )
        .velocity(
          { scale: [0.7, 1.05] },
          { delay: 0, duration: duration * 333, display: "block" }
        )
        .velocity(
          { scale: [1, 0.7] },
          {
  ...
  $.WOPOP_EFFECTS["fadeFromLeft"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      ...
      $(dom).css("opacity", 0);
      dom.velocity(
        { left: orileft + "px", opacity: orival },
        {
          delay: delay * 1000,
          duration: duration * 1000,
          display: "block",
  ...
  $.WOPOP_EFFECTS["fadeFromTop"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      ...
      if ($(dom).parents(".cstlayer").attr("type") == "pop_up") {
        ...
        $(dom).css(
          "top",
          0 - (container.scrollTop() + $(dom).height() + container.height())
        );
      }
      dom.velocity(
        { top: oritop + "px", opacity: orival },
  ...
  $.WOPOP_EFFECTS["effect.frombottom"] = function (dom, options) {
    ...
    _getEffectDom(dom).done(function (dom) {
      ...
      dom
        ...
        .velocity("reverse", { queue: reverse_effect });
    });
  };
    ...
    _getEffectDom(dom).done(function (dom) {
      if (hover == 1) {
        dom
          ...
          .velocity(
            { scale: [1] },
            { queue: reverse_effect, duration: duration }
          );
      } else {
        dom
          .velocity(
      ...
      if (is_product_list) {
        ...
        if (doms) {
          var dheight = parseInt(dom.height() * 1.05),
            thisheight = doms.height();
          if (hover == 1) {
            doms
              .css("margin-top", dheight - thisheight + "px")
              .velocity(
                { scale: [1.1] },
                {
                  delay: 0,
    ...
    _getEffectDom(dom).done(function (dom) {
      if (hover == 1) {
        dom
          ...
          .velocity(
            { scale: [1.1] },
            { queue: reverse_effect, duration: duration, display: "none" }
          );
      } else {
        dom
          .velocity(
  ...
  $.WOPOP_EFFECTS["effect.fade"] = function (dom, options, hover) {
    ...
    _getEffectDom(dom).done(function (dom) {
      if (hover == 1) {
        dom
          .velocity("transition.fadeIn", { duration: duration })
          .velocity("transition.fadeOut", {
            queue: reverse_effect,
            duration: duration,
          });
      } else {
        dom
  ...
  var effect_map =
    "callout.bounce,callout.shake,callout.flash,callout.pulse,callout.swing,callout.tada,";
  effect_map +=
    "transition.flipBounceXOut,transition.flipBounceYOut,transition.whirlOut,transition.shrinkOut,transition.perspectiveLeftOut,";
  effect_map +=
    "transition.expandOut,transition.bounceOut,transition.slideUpBigOut,transition.slideDownBigOut,transition.perspectiveRightOut,";
  effect_map +=
    "transition.slideLeftBigOut,transition.slideRightBigOut,transition.perspectiveUpOut,transition.perspectiveDownOut";
    ...
    if (!fullpagedom.length || force_show) {
      return this.each(function () {
        ...
        if (effects && effects.effect) {
          ...
          // 固定通栏里显示动画
          var infixedparentel = self.closest(
            ".full_column[infixed=1],.cstlayer[infixed=1]"
          );
          if (infixedparentel.length) {
            if (
              infixedparentel.parent().is("#canvas") &&
              parseInt(infixedparentel.css("top")) == 0
            ) {
              return;
            }
          ...
          if (inpopupparentel.length) {
            if (self.is(".now_effecting")) return;
            if (inpopupparentel.data("button_open") && opentype != "button")
              return;
          }
          ...
          if (!self.data("wopop_effect_oristyle"))
            self.data("wopop_effect_oristyle", style);
          ...
          if ($.WOPOP_EFFECTS[effects.effect] && browsersupport) {
            ...
            if (!$.wismobile && self.closest("#canvas").length) {
              _getEffectDom(self).done(function () {
                ...
                if (
                  cancontainer.length &&
                  (effects.effect == "frombottom" ||
                    effects.effect == "fadeFromBottom")
                ) {
                  var stacks = cancontainer.data("stacks");
                  if (!stacks) stacks = [];
  ...
  $.fn.setimgEffects = function (force_show, show_effects, hover) {
    ...
    if (!fullpagedom.length || force_show) {
      ...
      if (!(imgeffects && imgeffects.effect))
        imgeffects = self.data("wopop_imgeffects");
      if (imgeffects && imgeffects.effect) {
        ...
        if (imgeffects.effectrole == "blur") {
          if (!self.siblings("#imgmask").length) {
            ...
            var imgexit =
              '<img style="width:42px;height:42px;margin-top:' +
              imgtop +
              'px" src="' +
              imgsrc +
              '" alt="">';
            ...
            self.after(
              '<div id="imgmask" class="imgmask" data-color="' +
                colorval +
                '" data-opacity="' +
                opacity +
                '" style="text-align:center;position: absolute; top: ' +
                offsettop +
                "px;left:" +
                offsetleft +
                "px; background:" +
        ...
        if (imgeffects.effectrole == "content") {
          ...
          if (
            imgeffects.type == "tb_product_list" ||
            imgeffects.type == "product_list" ||
            imgeffects.type == "seckill_list" ||
            imgeffects.type == "groupon_list" ||
            imgeffects.type == "jfpro_list"
          ) {
            self.each(function () {
              ...
              if (!$(this).siblings("#imgmask").length) {
                $(this).after(
                  '<div id="imgmask" class="imgmask" data-top="' +
                    imgmask_top +
                    '" data-color="' +
                    colorval +
                    '" data-opacity="' +
                    ...
                    height +
                    'px;">' +
                    '<div class="effecttitle" style="color:' +
                    tfontcolor +
                    ";margin-top:" +
                    t_top +
                    "px;text-align:" +
                    ...
                    effecttitle +
                    "</div>" +
                    '<div class="effectcontent" style="color:' +
                    cfontcolor +
                    ";margin-top:" +
                    c_top +
                    "px;text-align:" +
          ...
          if (imgeffects.type == "article_list") {
            self.each(function () {
              var imgparent = $(this).closest("li");
              var effecttitle = imgparent
                .find("input[class=articleid]")
                .data("title");
              var effectcontent = imgparent
                .find("input[class=abstract]")
                .data("desc");
              if (twordcount) {
                effecttitle = subString(effecttitle, twordcount);
              }
              ...
              if (!$(this).siblings("#imgmask").length) {
                $(this).after(
                  '<div id="imgmask" class="imgmask" data-color="' +
                    ...
                    '" data-opacity="' +
                    opacity +
                    '" style=" position: absolute; top: 0px;left:0px; background:' +
                    bgcolor +
                    ';z-index: 1002; left: 0px;width:100%;height:100%;">' +
                    '<div class="effecttitle" style="color:' +
                    tfontcolor +
                    ";margin-top:" +
                    t_top +
            ...
            if (!self.siblings("#imgmask").length) {
              self.after(
                '<div id="imgmask" class="imgmask" data-color="' +
                  ...
                  bgcolor +
                  ';z-index: 1002; left: 0px;width:100%;height:100%;">' +
                  '<div class="effecttitle" style="line-height:140%;color:' +
                  tfontcolor +
                  ";margin-top:" +
                  t_top +
                  "px;line-height:" +
        ...
        if (imgeffects.effectrole == "title") {
          ...
          if (
            ...
            self.each(function () {
              ...
              var marginLeft = 0;
              if (imgeffects.type == "tb_product_list") {
                var marginLeft = 1;
              } else {
                marginLeft = 0;
              }
              ...
              if (imgeffects.type == "product_list") {
                ...
                var p_height =
                  imgparent.find(".img").height() || $(this).height();
              ...
              if (!$(this).siblings("#imgmask").length) {
                $(this).after(
                  '<div id="imgmask" class="imgmask" data-color="' +
                    ...
                    '" style="position: absolute; top: 0px;left:0px; background:' +
                    bgcolor +
                    ";z-index: 1002; left: 0px;width:100%;max-width:" +
                    width +
                    "px;height:" +
                    popheight +
                    "px;margin-top:" +
              ...
              if (!$(this).siblings("#imgmask").length) {
                $(this).after(
                  '<div id="imgmask" class="imgmask" data-color="' +
                    ...
                    '" style=" position: absolute; top: 0px;left:0px; background:' +
                    bgcolor +
                    ";z-index: 1002; left: 0px;width:100%;height:" +
                    popheight +
                    "px;margin-top:" +
                    margintop +
                    'px;">' +
        ...
        if (imgeffects.type == "media" && imgeffects.effectrole == "dantu") {
          var leavedom = self;
          if (self.closest(".cstlayer").data("iseffectrotate"))
            leavedom = self.closest(".cstlayer");
        } else if (
          imgeffects.type == "media" &&
          imgeffects.effectrole != "dantu"
        ) {
  ...
  function isDomInView(dom, container) {
    ...
    var navheight =
      $("#wp-mobile_navhandler").height() + $("#wp-mobile_navhandler").height();
  ...
  var effectparams = {
    fromleft: { delay: 0, duration: 1.2 },
    frombottom: { delay: 0, duration: 1.2 },
    fromright: { delay: 0, duration: 1.2 },
    fromtop: { delay: 0, duration: 1.2 },
    fade: { delay: 0, duration: 0.9 },
    rotation: { delay: 0, duration: 1.2 },
    rotation2d: { delay: 0, duration: 1.2 },
    bounceIn: { delay: 0, duration: 2.2 },
    big2small: { delay: 0, duration: 1.2 },
    small2big: { delay: 0, duration: 1.2 },
    fadeFromLeft: { delay: 0, duration: 1.2 },
    fadeFromBottom: { delay: 0, duration: 1.2 },
    fadeFromRight: { delay: 0, duration: 1.2 },
    fadeFromTop: { delay: 0, duration: 1.2 },
    light: { delay: 0, duration: 1.2 },
  };
  $.WOPOP_EFFECTS._getDefaultParam = function (effectname) {
    var opts = effectparams[effectname];
    if (!opts) opts = { delay: 0, duration: 1.2 };
    return opts;
  };
})(window);
...
function fullpagescrollresize(dom) {
  ...
  dom.resizable({
    ...
    resize: function (event, ui) {
      ...
      if ($.getElementAreaInf($(this)) == "canvas") {
        var maxbuttom = Math.max(
          curtop + fullpagescrollbuttompos,
          curtop + curheight
        );
        $.canvasheightresizeOrigin(maxbuttom);
      }
...
function fullpagescrolldrop(dom) {
  ...
  contentblock.droppable({
    tolerance: "pointer",
    accept:
      ".full_pagescroll,.cstlayer,.wp-new-tool-second-link,.wp-manage-plugin-block", //fullpage拖拽即时响应
    drop: function (event, ui) {
      var draggable = $.ui.ddmanager.current;
      //弹窗容器以及弹窗容器内的子插件在拖拽时不放在全屏滚动中
      if (
        $(draggable.element).attr("type") == "pop_up" ||
        $(draggable.element).parents(".cstlayer").attr("type") == "pop_up"
      ) {
        return;
      }
      if (
        ...
        if (
          !dom.hasClass("ui-modselected") ||
          $(draggable.element).is(".wp-new-tool-second-link") ||
          $(draggable.element).is(".wp-manage-plugin-block")
        ) {
          //fullpage拖拽即时响应
          $(this).children(".li-placeholder").hide();
          var existcolumn = $(document).data("layer_final_drop_id");
...
(function ($) {
  ...
  $.addFullPagescroll = function (top) {
    ...
    setTimeout(function () {
      if ($("#site_footer").length > 0) {
        ...
        if (confirm(translate("fullpage.Please hide site_footer"))) {
          $.post(
            parseToURL(fullpageClass, "prosf"),
            { pid: $.page_id },
            function (response) {
    ...
    var successfunc = function (resp, needchangeid) {
      ...
      if (needchangeid) {
        var fullpagescrollels =
          $(fullpagescrollhtml).filter(".full_pagescroll");
        var nowid = fullpagescrollels.prop("id");
        var newid = "layer" + fGuid();
        fullpagescrollhtml = fullpagescrollhtml.replace(
          new RegExp(nowid, "g"),
          newid
        );
      }
      ...
      var objarray = new Array();
      objarray[0] = new Array(
        parseInt($("#" + fullpagescrollel.prop("id")).css("z-index")),
        fullpagescrollel.prop("id")
      );
      $.zindexsort_new(objarray);
    };
    //使用缓存有问题 停用
  ...
  $.saveFullPagescrollObj = function (dom) {
    ...
    if (dom.prop("id") != "site_footer")
      otherparam = {
        fullpageext: dom.data("fullpageext"),
        top: $.parseInteger(dom.css("top")),
      };
    return $.extend(
      {
  ...
  $.wp_fullpag_mobile = function () {
    return /iphone|ipod|ipad|Macintosh|android|Windows phone/i.test(
...
function openImageChooserDialog(options) {
  ...
  wp_floatpanel(
    parseToURL("wp_widgets", "common_pic_chooser", {
      filetype: filetype,
      multi: multi,
    }),
    {
...
function transferToPageSetDialogcur(showdiv, hidediv, options) {
  ...
  if (mode == "edit") {
    url = parseToURL(modact, "editpage", {
      id: pageid,
      page_id: page_id,
      blockid: supid,
    });
  ...
  $.widget("wp.cstselect", {
    ...
    _create: function () {
      ...
      self._doinit(self).done(function (dom, selopts) {
        var $ctarget = dom,
          $diysel = $ctarget
            .next("." + selectclass + "-outside")
            .find("." + selectclass + "");
        // 设置默认值
        setTimeout(function () {
          var $cursel = $diysel.children("." + selectclass + "-left"),
            difw =
              $cursel.siblings("." + selectclass + "-button").outerWidth() + 2,
            pad =
              self._int($cursel.css("paddingLeft")) +
              self._int($cursel.css("paddingRight")),
            finalw = $diysel.width() - difw - pad + 1;
          if (finalw <= 0) finalw = Math.max(65, $ctarget.width()) - pad - 16;
          $cursel
            .width(finalw)
            .attr("val", $ctarget.val())
            .html($ctarget.find("option:selected").html());
    ...
    value: function (value) {
      ...
      $target.val(value);
      $select
        .find("." + selectclass + "-left")
        .attr("val", value)
        .html($target.children("option:selected").html());
    },
    _doinit: function (dom) {
      ...
      var selhtm =
        '<div class="' +
        selectclass +
        '-outside overz" style="float:left;width:' +
        selw +
        'px;"><div class="' +
        selectclass +
        '">';
      ...
      var search_class = "";
      if (isSearchable) {
        var imgsrc = relativeToAbsoluteURL(
          "template/default/images/searchico.png"
        );
        search_html =
          '<div class="searchable_div"><input type="text" value="" class="searchable_txt" ><div class="searchable_button"><img src="' +
          imgsrc +
          '" ></div></div>';
      ...
      selhtm +=
        '<div class="' +
        selectclass +
        '-left" val="0">&nbsp;</div><div class="' +
        selectclass +
        '-button"><a href="###" onclick="return false;"></a></div></div></div>';
      $target.after(selhtm);
      dtd.resolve(
        $target,
        '<div class="' +
    ...
    disable: function () {
      ...
      $select
        .find("." + selectclass + "-left")
        .css("color", "#7C7C7C")
        .attr("val", firstopt.value)
        .html(firstopt.innerHTML);
...
(function ($, undefined) {
  ...
  $.widget("wp.cstinput", {
    ...
    _create: function () {
      ...
      var uistyle =
          options.hasOwnProperty("style") && options.style.length
            ? ' style="' + options.style + '"'
            : "",
        nmstyle =
          options.hasOwnProperty("nmnode_style") && options.nmnode_style.length
            ? ' style="' + options.nmnode_style + '"'
            : "",
        btnstyle =
          options.hasOwnProperty("btnnode_style") &&
          options.btnnode_style.length
            ? ' style="' + options.btnnode_style + '"'
            : "",
        upstyle =
          options.hasOwnProperty("upbtn_style") && options.upbtn_style.length
            ? ' style="' + options.upbtn_style + '"'
            : "",
        downstyle =
          options.hasOwnProperty("downbtn_style") &&
          options.downbtn_style.length
            ? ' style="' + options.downbtn_style + '"'
            : "";
      $input.wrap(
        '<div class="wp_cstinput_helper"' +
          uistyle +
          ' unselectable="on"><div class="nminput_helper"' +
          nmstyle +
          ' unselectable="on"></div>' +
          '<div class="minplus_helper"' +
          btnstyle +
          ' unselectable="on"><span class="up"' +
          upstyle +
          ' unselectable="on"></span><span class="down"' +
          downstyle +
          ' unselectable="on"></span></div></div>'
      );
      // Default value
      if (options.hasOwnProperty("value") && options.regexp.test(options.value))
        $input.focus().val(options.value);
      // Maxlength
      if (
        options.hasOwnProperty("maxlength") &&
        /^[1-9]{1}\d*$/.test(options.maxlength)
      )
        $input.attr("maxlength", options.maxlength);
      // Unit(像素)
      if (options.hasOwnProperty("unit") && options.unit.length)
        $input
          .closest(".wp_cstinput_helper")
          .after(
            '<div class="wp_cstunit_helper" unselectable="on">' +
              options.unit +
              "</div>"
          );
      ...
      $buttons = $this.buttons = $input
        .closest(".wp_cstinput_helper")
        .find(".minplus_helper > span");
      upbtn = $buttons[0];
      downbtn = $buttons[1];
    ...
    _doCount: function (step) {
      ...
      if ($.isFunction(this.options.complete))
        this.options.complete(this.element, newval);
    },
  ...
  $.widget("wp.mscroll", {
    ...
    _create: function () {
      var self = this,
        ...
        maskbg = (self.options.maskbg || "").length
          ? "background:" + self.options.maskbg
          : "",
        barstr =
          '<div id="' +
          namespace +
      ...
      barstr +=
        ...
        creatid +
        '-bar" class="' +
        self.options.barcname +
        '"><span class="pane"></span></div>';
    ...
    _setScrollPos: function (id) {
      ...
      $mask.add($bar).css({
        left: function () {
          var curtype = $(this)
            .attr("id")
            .replace(prefid + "-", "");
          if (self.options[curtype + "left"])
            barleft = self.options[curtype + "left"];
          else {
            var swidth = getMscrollWidth() || 16;
            barleft =
              self._parseFloat($target.css("left")) + $target.width() - swidth;
          }
          return barleft + "px";
        },
      ...
      $bar.css("left", function () {
        return barleft + self._parseFloat(self.options.difleft || 0) + "px";
      });
    },
          ...
          .bind("mousedown." + namespace, function (e) {
            ...
            $(document)
              .bind("mousemove." + namespace, function (e) {
                ...
                // Reset pane-top
                var scrltop = self._parseFloat(
                    (panetop * contentH) / containerH
                  ),
            ...
            $(parent.document).bind("mouseup.rmscroll", function () {
              $(document).unbind("." + namespace);
            });
          })
          .bind("mouseup." + namespace, function (e) {
  ...
  function wp_floatpanel(load_url, option) {
    ...
    if (!$target.size()) {
      ...
      if (ol) {
        ...
        ols =
          '<div id="wp-floatpanel_overlay" style="z-index:' + z + ';"></div>';
        z += 1;
      }
      // Show or not bottom
      var sms = "";
      if (sm) {
        sms +=
          '<div class="wp-show_allpage"><input type="checkbox" name="show_allpage" value="" /><span>' +
          ...
          '<span class="wp-coordinate-lock overz"><img src="' +
          relativeToAbsoluteURL("template/default/images/un-lock.png") +
          '" width="16" height="15" /></span></div>';
      }
      // Loading area
      var $tmpwin = $(window),
        $load = $("#wp-floatpanel_loading"),
        loadstr =
          '<div id="wp-floatpanel_loading" style="z-index:' +
          (z - 1) +
          ';"><img src="' +
          relativeToAbsoluteURL("template/default/images/loading.gif") +
          '" width="16" height="16" /></div>';
      ...
      var $ap = $(
        '<div id="' +
          id +
          '" class="wp-floatpanel_dialog wp-manage_panel overz" style="display:none;position:absolute;z-index:' +
          z +
          ";" +
          ovecss +
          '" belong="' +
          (superid || null) +
          '"><div class="wp-title overz' +
          (config.titlebg ? " wp-title_black" : "") +
          '"><h2>' +
          config.title +
          "</h2>" +
        ...
        .draggable({
          ...
          start: function (e, ui) {
            ...
            if ($target.find("iframe").length > 0) {
              ...
              $(
                '<div class="ui-resizable-innerIframeFix" style="background-color:#FFF;"></div>'
              )
                .css({
                  left: 0,
                  top: titleH + "px",
          ...
          stop: function () {
            ...
            if (config.swfFix) {
              ...
              if ($swf.length > 0) {
                ...
                $swf.css({
                  height: (swfsize.height || 24) + "px",
                  width: (swfsize.width || 82) + "px",
                  visibility: "visible",
                });
        ...
        .bind("wpdialogclose", function (e) {
          ...
          var dialogid = dom.attr("id") || "",
            cancelarr = [
              ...
              "wp-file_explore",
              "wp_settemplate",
              "wp-filecategory_panel",
              "wp-manage_plugins",
              "wp_multilang_setting",
              "wp-backup",
              "wp-page_setting",
              "wp-seo_setting",
              "wp-watermark_setting",
              "wp-mobile_setting",
              "wp-add_template",
              "wp-ask_page_name",
              "wp-page_save",
    ...
    $.Deferred(function (dtd) {
      ...
      if (isfrm == false) {
        ...
        var frmw = plw - 26 /*左右padding值为2*13px*/,
          frame =
            '<div class="wp-iframe_beforloaded"><img src="' +
            relativeToAbsoluteURL("template/default/images/loading.gif") +
            '" width="16" height="16" /></div>' +
            '<iframe id="' +
            id +
            '_frame" name="' +
            id +
            '_frame" allowtransparency="true" frameborder="0" src="' +
            load_url +
            '" scrolling="auto" width="' +
            frmw +
            "\" onload=\"this.height=280;$('.wp-iframe_beforloaded','#" +
            id +
            "').remove();initFrame(this,'" +
            cc +
            "','" +
            plh +
            "');\"></iframe>";
      ...
      .fail(function () {
        wp_alert(
          config.title + "(deferred fail).<br/>" + translate("Request failed!")
        );
        $pnl.triggerHandler("wpdialogclose");
        return false;
      });
...
function set_pic(obj) {
  ...
  if (width > height) {
    ...
    $(obj).attr(
      "style",
      "width: " + _width + "px;height:" + _height + "px;left:" + _top + "px;"
    );
...
function msite_popup(url) {
  var $container = $("#scroll_container"),
    ...
    css =
      "position:absolute;top:0;left:0;width:320px;overflow:hidden;z-index:10000",
    ihtml =
      '<div class="mspopup_mask" style="background:url(' +
      bgimg +
      ") no-repeat 50% 20% #fff;height:" +
      maxh +
      "px;" +
      css +
      '"><iframe allowtransparency="true" frameborder="0" scrolling="no" width="320" height="' +
      maxh +
      '" src="' +
      url +
      '" onload="mspopup_onload(this)"></iframe></div>';

  var $mask = $container.children(".mspopup_mask");
  if (!$mask.length)
    $container
      .append(ihtml)
      .attr("data-height", $container.height())
      .height(maxh);
}
...
function wp_heightAdapt(dom, oldHeight) {
  ...
  var resetPos = function (el) {
    ...
    if (wrapArr && wrapArr.length) {
      ...
      if (h != el.height()) {
        el.css("height", h + "px");
        var wrapListPadding =
          parseInt(layer_first_div(el).css("padding-top")) +
          parseInt(layer_first_div(el).css("padding-bottom"));
        var wrapListBorder =
          parseInt(layer_first_div(el).css("border-top-width")) +
          parseInt(layer_first_div(el).css("border-bottom-width"));
        layer_first_div(el).height(
          el.height() - wrapListPadding - wrapListBorder
        );
      }
    }
    if (oritop != toppos) {
  ...
  if (dom.data("layer_height_min_apapt")) {
    if (dom.data("layer_height_min_apapt") > adaptModuleAfter)
      adaptModuleAfter = dom.data("layer_height_min_apapt");
  }
  ...
  if (
    ...
    adaptdoms.push({
      id: dom.prop("id"),
      diff: adaptModuleAfter - adaptModuleBefore,
    });
    $("#canvas").data("heightadaptdoms", adaptdoms);
  }

  var domPadding =
    parseInt(layer_first_div(dom).css("padding-top")) +
    parseInt(layer_first_div(dom).css("padding-bottom"));
  var domBorder =
    parseInt(layer_first_div(dom).css("border-top-width")) +
    parseInt(layer_first_div(dom).css("border-bottom-width"));
  var moduleLayerHeight =
    oldHeight || adaptModuleBefore + domPadding + domBorder;
  ...
  $("#canvas")
    ...
    .each(function () {
      ...
      var tmp_top = $(this).ab_pos_cnter("top"),
      ...
      if ($(this).hasClass("cstlayer")) {
        ...
        if (
          tmp_left <= left_boundray &&
          tmp_left + tmp_width >= right_boundray &&
          tmp_top <= moduleTop &&
          tmp_top + tmp_height >= moduleTop + moduleLayerHeight
        ) {
      ...
      if (
        $(this).parent().hasClass("full_content") ||
        $(this).parent().hasClass("footer_content") ||
        $(this).parent().hasClass("drop_box")
      )
        return true; //通栏和底部元素暂时不考虑
  ...
  //ceshi
  offsetY =
    $("#" + minId).ab_pos_cnter("top") - (moduleTop + moduleLayerHeight);
  ...
  if (wrapList.length > 0) {
    for (var i = 0; i < wrapList.length; i++) {
      ...
      var wrapListPadding =
        parseInt(layer_first_div(theel).css("padding-top")) +
        parseInt(layer_first_div($("#" + wrapList[i])).css("padding-bottom"));
      var wrapListBorder =
        parseInt(layer_first_div(theel).css("border-top-width")) +
        parseInt(
          layer_first_div($("#" + wrapList[i])).css("border-bottom-width")
        );
      layer_first_div(theel).height(
        theel.height() - wrapListPadding - wrapListBorder
      );
